 ...
 * <h2>SQL查询器，用于构造参数化SQL并执行，以避免SQL注入。支持批量模式。</h2>
 * <br/>QueryBuilder query = new QueryBuilder("SELECT * FROM "+TABLE_NAME);
 * <br/>Assert.assertTrue(20 == query.executeDataTable().getRowCount());
 * 
 * @author Darkness
