...
public class ExpressionParserTokenManager implements ExpressionParserConstants {
	...
	public void SwitchTo(int lexState) {
		if (lexState >= 1 || lexState < 0) {
			throw new TokenMgrError((new StringBuilder("Error: Ignoring invalid lexical state : ")).append(lexState).append(". State unchanged.").toString(), 2);
		} else {
	...
	static final int jjnextStates[] = { 22, 23, 24, 29, 30, 34, 35, 37, 42, 43, 10, 11, 13, 17, 12, 13, 17, 14, 16, 17, 34, 35, 37, 34, 35, 39, 37, 3, 4, 6, 7, 27, 28, 31, 32, 36, 38, 40, 42, 43 };
