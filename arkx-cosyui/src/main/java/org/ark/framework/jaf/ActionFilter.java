...
public class ActionFilter implements Filter {
    ...
    public static void invoke(HttpServletRequest request, HttpServletResponse response, String method)
        ...
        if (!PrivCheck.check(m, request, response)) {
            ExtendManager.invoke("org.ark.framework.AfterZActionPrivCheckFailedAction",
                    new Object[]{request, response, m});
            return;
        }
