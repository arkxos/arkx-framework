...
public class TreeAction {
	...
	public String getHtml() {
		...
		if (!this.lazyLoad) {
			sb.append("<div id='")
				.append(this.ID)
				.append("_container' class='treeContainer' style='-moz-user-select:none;")
				.append(styleStr)
				.append("'><div ztype='_Tree' onselectstart='stopEvent(event);' id='")
				.append(this.ID)
				.append("' method='")
				.append(this.method)
				.append("' class='treeItem'><table><tr><td>");
		}
