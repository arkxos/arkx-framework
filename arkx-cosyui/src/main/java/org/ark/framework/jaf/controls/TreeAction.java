    ...
    public void addChild(TreeItem parent) throws Exception {
        ...
        for (int i = 0; i < this.DataSource.getRowCount(); i++) {
            ...
            if ((parent.getID().equals(pid)) && (!StringUtil.isEmpty(id)) && (!id.equals(pid))) {
                childFlag = true;
                if ((parent.getLevel() >= this.level) && ((this.lazyLoad))) {// ||
                                                                             // (!this.expand)))
                                                                             // {
    ...
    public String getHtml() {
        ...
        if (!this.lazyLoad) {
            sb.append("<div id='").append(this.ID)
                    .append("_container' class='treeContainer' style='-moz-user-select:none;").append(styleStr)
                    .append("'><div ztype='_Tree' onselectstart='stopEvent(event);' id='").append(this.ID)
                    .append("' method='").append(this.method).append("' class='treeItem'><table><tr><td>");
        }
    ...
    public String getScript() {
        ...
        for (String k : this.Params.keySet()) {
            ...
            if ((k.equals("_ARK_TAGBODY")) || (v == null))
                continue;
            sb.append("Ark.Tree.setParam('").append(this.ID).append("','").append(k).append("',\"")
                    .append(StringUtil.javaEncode(v.toString())).append("\");");
        }

        sb.append("Ark.Tree.setParam('").append(this.ID).append("','").append("_ARK_TREE_STYLE").append("',\"")
                .append(this.style).append("\");");
        sb.append("Ark.Tree.setParam('").append(this.ID).append("','").append("_ARK_TREE_LEVEL").append("',")
                .append(this.level).append(");");
        sb.append("Ark.Tree.setParam('").append(this.ID).append("','").append("_ARK_TREE_LAZY").append("',\"")
                .append(this.lazy).append("\");");
        sb.append("Ark.Tree.setParam('").append(this.ID).append("','").append("_ARK_TREE_EXPAND").append("',\"")
                .append(this.expand).append("\");");
