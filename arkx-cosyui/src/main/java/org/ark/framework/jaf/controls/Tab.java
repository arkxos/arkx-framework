			...
			for (String[] arr : children) {
				...
				if ("iframe".equals(displayType)) {
					if (id.equals(selectedID)) {
						sb.append("<iframe ")
							.append(src)
							.append(" width=\"100%\" height=\"100%\" style=\"position:static;left:-22in;top:-11in;\" id=\"_ChildTabFrame_")
							.append(id)
						...
						sb.append(src)
							.append(" width='100%' height='100%' style=\"position:absolute;left:-22in;top:-11in;\" id=\"_ChildTabFrame_")
							.append(id)
							.append("\" frameborder=\"0\" scrolling=\"auto\" allowtransparency=\"true\"></iframe>");
					}
				}
