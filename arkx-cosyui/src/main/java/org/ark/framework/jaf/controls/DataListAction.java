...
public class DataListAction implements IPageEnableAction {
    ...
    public String getHtml() {
        ...
        sb.append("<input type=\"hidden\" id=\"").append(this.ID).append("\" method=\"").append(this.method)
                .append("\"");
        if (this.page) {
            sb.append(" page=\"true\"");
        }
    ...
    public String getScript() {
        ...
        sb.append("Ark.getDom('").append(this.ID).append("').TagBody = \"")
                .append(StringUtil.htmlEncode(getTagBody().replaceAll("\\s+", " "))).append("\";");
        for (String k : this.Params.keySet()) {
            Object v = this.Params.get(k);
            if ((k.equals("_ARK_TAGBODY")) || (v == null))
                continue;
            sb.append("Ark.DataList.setParam('").append(this.ID).append("','").append(k).append("',\"")
        ...
        sb.append("Ark.DataList.setParam('").append(this.ID).append("','").append("_ARK_PAGEINDEX").append("',")
                .append(this.pageIndex).append(");");
        sb.append("Ark.DataList.setParam('").append(this.ID).append("','").append("_ARK_PAGETOTAL").append("',")
                .append(this.total).append(");");
        sb.append("Ark.DataList.setParam('").append(this.ID).append("','").append("_ARK_PAGE").append("',")
                .append(this.page).append(");");
        sb.append("Ark.DataList.setParam('").append(this.ID).append("','").append("_ARK_SIZE").append("',")
                .append(this.pageSize).append(");");
        if (StringUtil.isNotEmpty(this.dragHandle)) {
            sb.append("Ark.DataList.setParam('").append(this.ID).append("','").append("_ARK_DRAGHANDLE").append("','")
                    .append(this.dragHandle).append("');");
        }
        if (StringUtil.isNotEmpty(this.sortEnd)) {
            sb.append("Ark.DataList.setParam('").append(this.ID).append("','").append("_ARK_SORTEND").append("','")
                    .append(this.sortEnd).append("');");
        }
        sb.append("");
