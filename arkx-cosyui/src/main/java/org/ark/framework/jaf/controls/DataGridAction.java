...
//
// public static Pattern sortPattern = Pattern.compile("[\\w\\,\\s]*",
...
// html = scrollWrap();
// } else {
// if ((!dataGrid.isTreeFlag()) && (this.PageFlag) && (dataGrid.getPageBar() !=
// null)) {
// dealPageBar();
...
//
// sb.append("<div id='").append(this.ID).append("_Wrap' class='z-datagrid
// dg_scrollable dg_nobr' ztype='_DataGridWrapper'");
// if (StringUtil.isNotEmpty(fw)) {
// sb.append(" style='width:").append(fw).append(";'");
// }
// sb.append(">");
// sb.append("<div id='").append(this.ID).append("_Wrap_head'
// class='dg_head'>");
...
// td.InnerHTML = ("<div id='dataTable0_th" + i + "' class='dg_th'>" +
// td.InnerHTML + "</div>");
// }
// sb.append(tmpTable.getOuterHtml());
// sb.append("</div>");
//
// sb.append("<div id='").append(this.ID).append("_Wrap_body' class='dg_body'
// style='");
...
// dataGrid.getPageBar().getTD(0).setAttribute("pagebartype",
// dataGrid.getPageBar().getAttribute("pagebartype"));
// } catch (Exception e) {
// e.printStackTrace();
// }
...
// sb.append("\nArk.getDom('").append(this.ID).append("').DataSource = new
// Ark.DataTable();");
// sb.append("\nArk.getDom('").append(this.ID).append("').DataSource.init(_Ark_Cols,_Ark_Values);");
// sb.append("\nwindow.attachEvent('onunload',
// function(){Ark.DataGrid.destroy('").append(this.ID).append("');});");
// }
// sb.append("\nvar _Ark_Arr = [];");
...
// }
// sb.append("\nArk.getDom('").append(this.ID).append("').TemplateArray =
// _Ark_Arr;");
...
// }
// sb.append("\nArk.getDom('").append(this.ID).append("').EditArray =
// _Ark_Arr;");
// }
//
// sb.append("\nArk.getDom('").append(this.ID).append("').TagBody =
// \"").append(StringUtil.htmlEncode(getTagBody().replaceAll("\\s+", "
// "))).append("\";");
...
// sb.append("\nArk.DataGrid.setParam('").append(this.ID).append("','").append("_ARK_PAGETOTAL").append("',"
// + this.Total).append(");");
...
// }
// sb.append("\nArk.DataGrid.setParam('").append(this.ID).append("','").append("_ARK_MULTISELECT").append("','"
// + this.MultiSelect).append("');");
...
// }
// DataTableUtil.dataTableToExcel(dt, (OutputStream)
// this.Params.get("_OutputStream"), columnNames, widths);
// } else {
// this.DataSource = dt;
// try {
// bindData();
...
// }
//
// public String getPageBarHtml(String id, Mapx<String, Object> params, int
// total, int pageIndex, int pageSize) {
// return getPageBarHtml(id, params, total, pageIndex, pageSize, false);
// }
//
// public String getPageBarHtml(String id, Mapx<String, Object> params, int
// total, int pageIndex, int pageSize, boolean simpleFlag) {
// StringBuilder sb = new StringBuilder();
// int totalPages = Double.valueOf(Math.ceil(total * 1.0D /
// pageSize)).intValue();
//
...
//
// sb.append("<div class='tfoot-fr' style='float:right;'><div
// class='pagebar'>&nbsp;");
//
// sb.append("<span class='first'>").append("<a href='javascript:void(0);'
// onclick=\"DataGrid.firstPage('").append(id).append("');\">").append(first).append("</a>").append("</span>");
// sb.append("<span class='previous'>").append("<a href='javascript:void(0);'
// onclick=\"DataGrid.previousPage('").append(id).append("');\">").append(prev).append("</a>").append("</span>");
//
// sb.append("<span class='next'>").append("<a href='javascript:void(0);'
// onclick=\"DataGrid.nextPage('").append(id).append("');\">").append(next).append("</a>").append("</span>");
// sb.append("<span class='last'>").append("<a href='javascript:void(0);'
// onclick=\"DataGrid.lastPage('").append(id).append("');\">").append(last).append("</a>").append("</span>");
//
// if (!simpleFlag) {
// sb.append("&nbsp;&nbsp;").append(gotoPage).append("&nbsp;<input
// id='_PageBar_Index_").append(id).append("' type='text' class='inputText
// gotopage' value=\"").append(pageIndex + 1)
// .append("\"");
// sb.append(
// "
// onKeyUp=\"value=value.replace(/\\D/g,'');style.width=Math.min(7*(value.length||1)+1,36)+'px';\"
// onkeydown=\"if(Ark.getEvent().keyCode==13)document.getElementById('_PageBar_JumpBtn_")
// .append(id).append("').onclick();\">");
// sb.append("/<span
// class=\"js_totalPages\">").append(totalPages).append("</span>");
// sb.append(gotoEnd).append("&nbsp;");
// sb.append("<input type='button' id='_PageBar_JumpBtn_").append(id).append("'
// class='pageJumpBtn' onclick=\"var
// v=document.getElementById('_PageBar_Index_").append(id)
// .append("').value;if(!/^\\d+$/.test(v)").append("||v<1||v>Number(Ark.DataGrid.getParam('").append(id).append("',
// Constant.PageTotal))/Number(Ark.DataGrid.getParam('").append(id)
// .append("',
// Constant.Size))+1){alert('").append(error).append("');document.getElementById('_PageBar_Index_").append(id)
// .append("').focus();}else{var pageIndex =
// ($V('_PageBar_Index_").append(id).append("')-1)>0?$V('_PageBar_Index_").append(id).append("')-1:0;DataGrid.setParam('").append(id)
// .append("','").append("_ARK_PAGEINDEX").append("',pageIndex);DataGrid.loadData('").append(id).append("');}\"
// value='' title='").append(gotoButton).append("'>");
// }
// sb.append("</div></div>");
// sb.append("<div class='tfoot-fl' style='float:left;'>");
// String node_total = "<span class='js_total'>" + String.valueOf(total) +
// "</span>";
// String node_pageSize = "<span class='js_pageSize'>" +
// String.valueOf(pageSize) + "</span>";
// String node_pageIndex = "<span class='js_pageIndex'>" +
// String.valueOf(totalPages == 0 ? 0 : pageIndex + 1) + "</span>";
// String node_totalPages = "<span class='js_totalPages'>" +
// String.valueOf(totalPages) + "</span>";
//
// sb.append(new StringFormat(pagebar, new Object[] { node_total, node_pageSize,
// node_pageIndex, node_totalPages }));
//
// return sb.toString();
// }
//
// public static String getPageBarHtml1(String id, Mapx<String, Object> params,
// int total, int pageIndex, int pageSize, boolean simpleFlag) {
// StringBuilder sb = new StringBuilder();
// int totalPages = Double.valueOf(Math.ceil(total * 1.0D /
// pageSize)).intValue();
//
...
// sb.append(new StringFormat(pagebar, new Object[] { Integer.valueOf(total),
// Integer.valueOf(pageSize), Integer.valueOf(totalPages == 0 ? 0 : pageIndex +
// 1), Integer.valueOf(totalPages) }));
//
// sb.append("\">");
// String node_total = "<span class='js_total'>" + String.valueOf(total) +
// "</span>";
...
// String.valueOf(totalPages) + "</span>";
//
// sb.append(new StringFormat(pagebar1, new Object[] { node_total,
// node_pageSize, node_pageIndex, node_totalPages }));
//
// return sb.toString();
// }
//
// public static String getPageBarHtml2(String id, Mapx<String, Object> params,
// int total, int pageIndex, int pageSize, boolean simpleFlag) {
// StringBuilder sb = new StringBuilder();
// int totalPages = Double.valueOf(Math.ceil(total * 1.0D /
// pageSize)).intValue();
...
// this.PageIndex = Double.valueOf(Math.floor(this.Total * 1.0D /
