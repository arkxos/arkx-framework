 ...
 * <h2>Select标签</h2> <br/>
 * <img src="images/SelectTag_1.png"/> <br/>
 * &lt;ark:select id="parentInnerCode" condition="$V('branchInnerCode').length!=4"
 * value="${parentInnerCode}" method="Branch.getBranchTable" defaultBlank="true"
 * verify="NotNull" style="width:200px"/> <br/>
 * <br/>
 * <b>select下拉页面</b> <br/>
 * &lt;ark:select id="Site" listURL="ContentCore/SiteSelectDialog.zhtml" autowidth="true"
 * <br/>
 * listWidth="250" listHeight="300" style="height:16px;" value="${SiteID}" <br/>
 * valueText="${SiteName}" onchange="onSiteChange()" /> <br/>
 * <br/>
 * <b>listUrl中的选择事件</b> <br/>
 * function onTreeClick(ele){ <br/>
 * &nbsp;&nbsp;&nbsp;&nbsp; var v = ele.getAttribute("cid"); <br/>
 * &nbsp;&nbsp;&nbsp;&nbsp; if(!v){ <br/>
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return; <br/>
 * &nbsp;&nbsp;&nbsp;&nbsp; } <br/>
 * &nbsp;&nbsp;&nbsp;&nbsp; var t = ele.innerText; <br/>
 * &nbsp;&nbsp;&nbsp;&nbsp; Selector.setReturn(t,v); <br/>
 * }
 * @author Darkness
...
public class SelectTag extends BodyTagSupport {
	...
	public static final Pattern POption = Pattern
		.compile("<(span|option).*?value=(\\\"|\\')(.*?)\\2.*?>(.*?)</(span|option)>", 34);
	...
	public String getHtml(String content) {
		...
		if (StringUtil.isNotEmpty(this.style)) {
			sb.append(" style=\"display:inline-block; *zoom: 1;*display: inline;vertical-align:middle;")
				.append("height:auto;width:auto;position:relative;border:none 0;margin:0;padding:0;white-space: nowrap")
				.append("\"");
		...
		sb.append("<input type=\"text\" id=\"")
			.append(this.id)
			.append("_textField\" ztype=\"select\" autocomplete=\"off\"");
		if (StringUtil.isNotEmpty(this.verify)) {
			sb.append(" verify=\"").append(this.verify).append("\"");
		}
		if (StringUtil.isNotEmpty(this.className)) {
		...
		sb.append("<img class=\"arrowimg\" src=\"")
			...
			.append("Framework/Images/blank.gif\" width=\"18\" height=\"20\" id=\"")
			.append(this.id)
		...
		sb.append("<div id=\"")
			.append(this.id)
			.append("_list\" class=\"optgroup\" style=\"text-align:left;display:none;\">");
	...
	public static String getOptionHtml(String text, String value, boolean flag) {
		...
		return "<a href=\"javascript:void(0);\" onclick=\"Ark.Selector.onItemClick(this);\" onmouseover=\"Ark.Selector.onItemMouseOver(this)\" "
				+ (flag ? "selected=\"true\"" : "") + " hidefocus value=\"" + value + "\">" + text + "</a>";
	}
	...
	private String parseOptions(String content) {
		...
		while (m.find(lastIndex)) {
			...
			if (this.showValue)
				sb.append(getOption(m.group(3) + (StringUtil.isNotEmpty(m.group(4)) ? "-" + m.group(4) : ""),
						m.group(3)));
			else {
	...
	private String getCodeData() {
		...
		DataTable dt = null;// getCodeData(this.code, this.method, this.options,
							// this.pageContext, params);
		StringBuilder sb = new StringBuilder();
		if (dt != null) {
			...
			if (dt.getColumnCount() > 2) {
				...
				sb.append("window.attachEvent('onunload', function(){Ark.Selector.destroy('")
					.append(this.id)
					.append("')});");
				sb.append("}\n</script>\n");
			}
	...
	public static DataTable getCodeData(String code, String method, String options, PageContext pageContext,
		...
		if (ObjectUtil.notEmpty(method))
			try {
				...
				Method m = Current.prepareMethod((HttpServletRequest) pageContext.getRequest(),
						(HttpServletResponse) pageContext.getResponse(), method, null);
				if (!PrivCheck.check(m, (HttpServletRequest) pageContext.getRequest(),
