 ...
 *        &lt;ark:select id="parentInnerCode"
 *        condition="$V('branchInnerCode').length!=4" value="${parentInnerCode}"
 *        method="Branch.getBranchTable" defaultBlank="true" verify="NotNull"
 *        style="width:200px"/> <br/>
 *        <br/>
 *        <b>select下拉页面</b> <br/>
 *        &lt;ark:select id="Site" listURL="ContentCore/SiteSelectDialog.zhtml"
 *        autowidth="true" <br/>
 *        listWidth="250" listHeight="300" style="height:16px;"
 *        value="${SiteID}" <br/>
...
public class SelectTag extends BodyTagSupport {
    ...
    public String getHtml(String content) {
        ...
        sb.append("<div id=\"").append(this.id).append("\" selectedIndex=\"").append(this.selectedIndex)
                .append("\" name=\"").append(this.name).append("\" ztype=\"Select\"");
        ...
        sb.append("<input type=\"text\" id=\"").append(this.id)
        ...
        sb.append("<div id=\"").append(this.id)
    ...
    private String getCodeData() {
        ...
        if (dt != null) {
            ...
            if (dt.getColumnCount() > 2) {
                ...
                sb.append("window.attachEvent('onunload', function(){Ark.Selector.destroy('").append(this.id)
                        .append("')});");
                sb.append("}\n</script>\n");
            }
        }
