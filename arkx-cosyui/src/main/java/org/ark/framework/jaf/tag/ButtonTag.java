...
public class ButtonTag extends BodyTagSupport {
	...
	public int doAfterBody() throws JspException {
		...
		try {
			...
			getPreviousOut().print(getHtml(this.id, this.name, this.type, this.theme, this.menu, this.onClick,
					this.href, this.target, this.priv, img, text, this.checked, this.disabled));
		}
		catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static String getHtml(String name, String theme, String onclick, String priv, String img, String text,
			boolean disabled) {
		return getHtml(null, name, null, theme, null, onclick, null, null, priv, img, text, false, disabled);
	}

	public static String getHtml(String id, String name, String type, String theme, String menu, String onclick,
			String href, String target, String priv, String img, String text, boolean checked, boolean disabled) {
