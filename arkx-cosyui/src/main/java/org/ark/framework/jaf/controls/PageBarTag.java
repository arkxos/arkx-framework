...
public class PageBarTag extends BodyTagSupport {
    ...
    public static String getDefault(PageBarTag pageBarTag, String target, int total, int pageSize, int pageIndex) {
        ...
        if (pageIndex > 0) {
            if ((pageBarTag.action instanceof DataListAction)) {
                sb.append("<span class=\"first\"><a href='javascript:void(0);' onclick=\"Ark.DataList.firstPage('")
                        .append(target).append("');\">").append(first).append("</a></span>&nbsp;|&nbsp;");
                sb.append(
                        "<span class=\"previous\"><a href='javascript:void(0);' onclick=\"Ark.DataList.previousPage('")
                        .append(target).append("');\">").append(prev).append("</a></span>&nbsp;|&nbsp;");
            } else {
                sb.append("<a href='").append(queryString).append("1'>").append(first).append("</a>&nbsp;|&nbsp;");
                sb.append("<a href='").append(queryString).append(pageIndex).append("'>").append(prev)
                        .append("</a>&nbsp;|&nbsp;");
            }
        } else {
        ...
        if ((totalPages != 0) && (pageIndex + 1 != totalPages)) {
            if ((pageBarTag.action instanceof DataListAction)) {
                sb.append("<span class=\"next\"><a href='javascript:void(0);' onclick=\"Ark.DataList.nextPage('")
                        .append(target).append("');\">").append(next).append("</a></span>&nbsp;|&nbsp;");
                sb.append("<span class=\"last\"><a href='javascript:void(0);' onclick=\"Ark.DataList.lastPage('")
                        .append(target).append("');\">").append(last).append("</a></span>");
            } else {
                sb.append("<a href='").append(queryString).append(pageIndex + 2).append("'>").append(next)
                        .append("</a>&nbsp;|&nbsp;");
                sb.append("<a href='").append(queryString).append(totalPages).append("'>").append(last)
                        .append("</a>&nbsp;|&nbsp;");
            }
        } else {
        ...
        sb.append("<input type='button' id='_PageBar_JumpBtn_").append(target)
                ...
                .append("').value;if(!/^\\d+$/.test(v)").append("||v<1||v>Number(Ark.DataList.getParam('")
                .append(target).append("', Constant.PageTotal))/Number(Ark.DataList.getParam('").append(target)
                .append("', Constant.Size))+1){alert('").append(error)
                .append("');document.getElementById('_PageBar_Index_").append(target).append("').focus();}")
                .append("else{var pageIndex = v>0?v-1:0;");
        if ((pageBarTag.action instanceof DataListAction))
            sb.append("Ark.DataList.setParam('").append(target).append("','").append("_ARK_PAGEINDEX")
                    .append("',pageIndex);Ark.DataList.loadData('").append(target).append("');");
        else {
        ...
        sb.append(new StringFormat(pagebar,
                new Object[]{"<span class=\"js_total\">" + total + "</span>",
                        "<span class=\"js_pageSize\">" + pageSize + "</span>",
    ...
    private String getType1(String target, int total, int pageSize, int pageIndex) {
        ...
        sb.append(new StringFormat(pagebar, new Object[]{Integer.valueOf(total), Integer.valueOf(pageSize),
                Integer.valueOf(totalPages == 0 ? 0 : pageIndex + 1), Integer.valueOf(totalPages)}));
        sb.append("\">");
