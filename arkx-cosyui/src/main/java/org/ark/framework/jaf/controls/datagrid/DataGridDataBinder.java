...
// dataGridAction.DataSource =
// DataTableUtil.sortTreeDataTable(dataGridAction.DataSource, "ID", "ParentID");
// }
// }
...
//
// String ztype =
// dataGridAction.dataGrid.getHeader().getTD(i).getAttribute("ztype");
//
// for (DataGridColumnFixer dataGridColumnFixer : dataGridColumnFixers) {
// if(dataGridColumnFixer.match(ztype)) {
// dataGridColumnFixer.fixColumn(dataGridAction.Table, dataGridAction, i,
// dataGridAction.PageIndex, dataGridAction.PageSize);
// }
// }
//
// }
...
// clickEvent = "";
// }
// tr.setAttribute("onclick", "Ark.DataGrid.onRowClick(this,event);" +
// clickEvent);
...
// else if ((WebCurrent.getRequest() != null) &&
// (WebCurrent.getRequest().containsKey(key)))
// sb.append(WebCurrent.getRequest().getString(key));
// else if ((Current.getResponse() != null) &&
// (Current.getResponse().containsKey(key)))
...
// dataGridAction.DataSource.insertColumn(new DataColumn("_RowNo",
// DataTypes.INTEGER));
