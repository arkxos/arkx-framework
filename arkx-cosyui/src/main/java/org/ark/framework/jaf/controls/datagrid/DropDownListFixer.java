...
//
// @Override
// public void fixColumn(HtmlTable table, DataGridAction dataGridAction, int i,
// Object... params) {
// String field =
// dataGridAction.dataGrid.getHeader().getTD(i).getAttribute("field");
// String sql =dataGridAction.
// dataGrid.getHeader().getTD(i).getAttribute("sql");
// String zstyle =
// dataGridAction.dataGrid.getHeader().getTD(i).getAttribute("zstyle");
...
// sb.append("<div ztype='select' disabled='true'
// style='display:none;").append(zstyle).append(";'
// name='").append(dataGridAction.ID).append("_").append(field).append("_DropDownList")
// .append(j).append("'
// id='").append(dataGridAction.ID).append("_").append(field).append("_DropDownList").append(j).append("'
// >");
...
// }
// sb.append("<span value='").append(dt.getString(k, 0)).append("'
// ").append(selected).append(">").append(dt.getString(k, 1)).append("</span>");
// }
// sb.append("</div>");
