...
public class ZhtmlManager {
    ...
    public static void forward(String url, HttpServletRequest request, HttpServletResponse response,
            ServletContext context) throws ZhtmlRuntimeException, ZhtmlCompileException, ServletException, IOException {
    ...
    public static boolean execute(String url, HttpServletRequest request, HttpServletResponse response,
            ServletContext context) throws ZhtmlRuntimeException, ZhtmlCompileException {
        ...
        PageContext pageContext = JspFactory.getDefaultFactory().getPageContext(servlet, request, response, null,
                je.sessionFlag, 8192, true);
    ...
    private static boolean needReload(ZhtmlExecutor je, String fileName) throws FileNotFoundException {
        ...
        if (System.currentTimeMillis() - je.getLastModified() <= 3000L)
            return false;
        f = new File(FileUtil.normalizePath((new StringBuilder(String.valueOf(Config.getContextRealPath()))).append("/")
