 ...
 *        t.tablename,CONCAT(CONCAT(CONCAT(t.alias,'('),t.tablename),')') AS
 *        alias,t.categoryid AS parentTable FROM PT_SYS_XTable t ORDER BY
 *        t.tablename").executeDataTable(); <br/>
 ...
 *        <br/>
 *        dt.insertRow(new Object[] { "数据库类型", dcc.getDatabaseType().getName(),
 *        "-1" }); <br/>
 ...
 *        "select cv.refid as tableName,cv.chinaname as alias,'数据库名称' as
 *        parentTable from pt_sys_categoryValue cv join pt_sys_category c on
 *        cv.categoryid=c.id and c.constname = 'TABLE_CATEGORYID'") <br/>
 *        .executeDataTable()); <br/>
 *        ta.bindData(dt); <br/>
 *        <br/>
 ...
 *        <br/>
 *        Tree.select("tree1", "xname", "pt_sys_config", true);// true
 *        表示执行onclick事件 <br/>
 *        }); <br/>
 *        <br/>
 *        <b>自定义节点</b> <br/>
