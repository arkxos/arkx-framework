 ...
 * } <br>
 * <br>
 * &lt;ark:uploader id="DBFile" width="300" allowType="zdt" fileCount="1"/> <br>
 * <br>
 ...
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var taskID =
 * response.get("TaskID"); <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var p = new
 * Progress(taskID,"<ark:lang id= "SysInfo.DBImporting">数据导入中</ark:lang>...",500,150);
 * <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 * p.show(function(){ <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 * &nbsp;&nbsp;&nbsp;&nbsp; final String FileName = AppDataPath.getValue() +
 * "backup/DBUpload_" + DateUtil.getCurrentDate("yyyyMMddHHmmss") + ".zdt"; <br>
 * &nbsp;&nbsp;&nbsp;&nbsp; try { <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ua.getFirstFile().write(new
 * File(FileName)); <br>
 ...
 * &nbsp;&nbsp;&nbsp;&nbsp; if (ltt != null) { <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 * this.Response.setFailedMessage(LangMapping.get("SysInfo.Installing")); <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return; <br>
 * &nbsp;&nbsp;&nbsp;&nbsp; } <br>
