 ...
 *        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;input
 *        type="checkbox" value="${Item}" onclick="onColumnSelect(this)" />
 *        <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${Name} <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp;&lt;/td> <br/>
 *        &lt;/ark:list> <br/>
 ...
 *        &nbsp;&nbsp;&nbsp;&nbsp; &lt;td> <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp; &lt;ark:select
 *        id="participantValue_${_RowNo}"
 *        method="ContractCalculation.findParticipantValues" <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp; defaultblank="true" value="${id}"
 *        style="width: 200px" listWidth="200" /> <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp; &lt;/td> <br/>
 *        &lt;/tr> <br/>
 *        &lt;/ark:list> <br/>
 *        <br/>
 ...
 *        { <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 *        dataTable.insertRow(new Object[] { participant.getId(),
 *        participant.getName() }); <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp; } <br/>
 *        <br/>
 ...
 *        Request.getString("currentRow.id"); <br/>
 *        <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp; DataTable result = new DataTable("id",
 *        "name"); <br/>
 *        <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp; Criteria criteria = new
 *        Criteria(ParticipantValue.class); <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp;
 ...
 *        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; for (ParticipantValue
 *        participantValue : participantValues) { <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 *        result.insertRow(new Object[] { participantValue.getId(),
 *        participantValue.getValue() }); <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp; } <br/>
 *        <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp; return result; <br/>
 ...
 *        &nbsp;&nbsp;&nbsp;&nbsp; &lt;ark:if
 *        condition="${needStartTr}">&lt;tr>&lt;/ark:if> <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;td valign="top"
 *        class="text" align="center"> <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 *        &lt;div id="chartdiv_month${date}" align="center">FusionCharts.
 *        &lt;/div> <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/td> <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp; &lt;ark:if
 *        condition="${needEndTr}">&lt;/tr>&lt;/ark:if> <br/>
 *        </ark:list> <br/>
 *        public void bindDateList(ListAction la) { <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp; String[] months = new String[] { "09-01",
 ...
 *        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; i++; <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; dt.insertRow(new
 *        Object[] { month , needStartTr, needEndTr}); <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp; } <br/>
 *        <br/>
 *        &nbsp;&nbsp;&nbsp;&nbsp; la.bindData(dt); <br/>
 *        }
