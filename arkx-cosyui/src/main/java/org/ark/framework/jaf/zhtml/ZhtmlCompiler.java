...
public class ZhtmlCompiler {
	...
	public void compile(String JspFileName)
			throws FileNotFoundException, ZhtmlCompileException, NotPrecompileException {
	...
	public void compileSource(String source)
			throws ZhtmlCompileException, ZhtmlCompileException, NotPrecompileException {
