...
// String checkedvalue =
// dataGridAction.dataGrid.getHeader().getTD(i).getAttribute("checkedvalue");
// String disabled =
// dataGridAction.dataGrid.getHeader().getTD(i).getAttribute("disabled");
...
// String checked = checkedvalue.equals(dataGridAction.DataSource.getString(j -
// 1, field)) ? "checked" : "";
// dataGridAction.Table
// .getTR(j)
// .getTD(i)
// .setInnerHTML(
// "<input type='checkbox' " + disabled + " name='" + dataGridAction.ID + "_" +
// field + "_Checkbox' id='" + dataGridAction.ID + "_" + field + "_Checkbox" + j
// + "' value='"
