...
// Object... params) {
// String field =dataGridAction.
// dataGrid.getHeader().getTD(i).getAttribute("field");
// String checkedExpr =
// dataGridAction.dataGrid.getHeader().getTD(i).getAttribute("checked");
//
...
// context.addMap(dataGridAction.DataSource.getDataRow(j -
// 1).toCaseIgnoreMapx(), "List");
// try {
...
// nextLevel =
// Integer.parseInt(dataGridAction.DataSource.getString(j-headTrSize+1,
// "_TreeLevel"));
// }
// if (level < nextLevel)
// sb.append("<img
// src='").append(Config.getContextPath()).append("Framework/Images/butExpand.gif'
// onclick='DataGrid.treeClick(this)'/>&nbsp;");
// else {
// sb.append("<img
// src='").append(Config.getContextPath()).append("Framework/Images/butNoChild.gif'/>&nbsp;");
// }
...
// level='").append(level).append("' onClick='treeCheckBoxClick(this);'>");
// }
//
