...
//
// String field =
// dataGridAction.dataGrid.getHeader().getTD(columnIndex).getAttribute("field");
// String onSelect =
// dataGridAction.dataGrid.getHeader().getTD(columnIndex).getAttribute("onselect");
// if (onSelect == null) {
// onSelect = "";
// }
// if (dataGridAction.MultiSelect) {
// dataGridAction.dataGrid.getHeader().getTD(columnIndex)
// .setInnerHTML("<input type='checkbox' value='*' id='" + dataGridAction.ID +
// "_AllCheck' onclick=\"Ark.DataGrid.onAllCheckClick('" + dataGridAction.ID +
// "')\"/>");
// }
...
//
// String fieldValue = dataGridAction.DataSource.getString(j - headTrSize,
// field);
//
...
// .getTD(columnIndex)
// .setInnerHTML(
// "<input type='" + type + "' name='" + dataGridAction.ID + "_RowCheck' id='" +
// dataGridAction.ID + "_RowCheck" + j + "' value='"
// + fieldValue + "'>");
// dataGridAction.Table.getTR(j).getTD(columnIndex).setAttribute("class",
// "selector");
// dataGridAction.Table.getTR(j).getTD(columnIndex).setAttribute("onclick",
// "Ark.DataGrid.onSelectorClick(this,event);" + onSelect);
// dataGridAction.Table.getTR(j).getTD(columnIndex).setAttribute("ondblclick",
