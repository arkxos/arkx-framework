...
public class TreeBody {
    ...
    private void rewrite(TreeAction ta) {
        ...
        sb.append("<div id='").append(ID).append("_outer' class='treeContainer' style='-moz-user-select:none;")
                .append(ta.getStyle()).append("'><div ztype='tree' onselectstart='stopEvent(event);' id='").append(ID)
                .append("' method='").append(ta.getMethod()).append("' rest='").append(ta.getRest())
                .append("' class='z-tree'");
        ...
        sb.append(
                "\" class='tree-skeleton-icon' style='background:url(${Config['App.ContextPath']}${_TreeAction.RootIcon}) no-repeat center center;'>");
    ...
    private void getScript(TreeAction ta, FastStringBuilder sb) {
        ...
        sb.append("tree.setParam('").append(Constant.TreeParentColumn).append("','")
                .append(ta.getParentIdentifierColumnName()).append("');");
        ...
        sb.append("<ark:if condition='${!_TreeAction.AjaxRequest}'>");
        sb.append("Ark.Page.onLoad(function(){Tree_").append(ID).append("_Init(Tree_").append(ID)
                .append("_Update);}, 7);");
        sb.append("</ark:if>");
    }
