...
public class PlaceHolderUtil {
    ...
    public static String replacePlaceHolder(String html, Map<?, ?> map, boolean blankFlag, boolean spaceFlag)
        ...
        for (PlaceHolder p : list) {
            ...
            if (p.isExpression) {
                Object v = ZhtmlManagerContext.getInstance().getEvaluator().evaluate(p.Value, Object.class, vr,
    ...
    public static String replaceWithDataTable(String html, DataTable dt, boolean blankFlag, boolean spaceFlag)
            throws ExpressionException {
