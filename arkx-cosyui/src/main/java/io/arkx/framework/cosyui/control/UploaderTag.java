...
public class UploaderTag extends ArkTag {
	...
	// String FlashVars = "";
	// String srcSWF = Config.getContextPath() +
	// "framework/components/ZUploader2.swf";
	...
	// sb.append("<!--[if IE]>");
	// sb.append("<object id=\"" + id + "\" name=\"" + name + "\"
	...
	// sb.append("<!--[if !IE]>-->");
	// sb.append("<object id=\"" + id + "\" name=\"" + name + "\"
	// type=\"application/x-shockwave-flash\" data=\"" + srcSWF + "\" width=\""
	// + width + "\" height=\"" + height + "\"
	...
	public String getFlashHtml(String content) {
		...
		StringBuilder sb = new StringBuilder();
		sb.append("<!--[if IE]>");
		sb.append("<object id=\"" + this.id + "\" name=\"" + this.name
				+ "\" classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\" width=\"" + this.width + "\" height=\""
		...
		sb.append("<!--[if !IE]>-->");
		sb.append("<object id=\"" + this.id + "\" name=\"" + this.name
				+ "\" type=\"application/x-shockwave-flash\" data=\"" + srcSWF + "\" width=\"" + this.width
				+ "\" height=\"" + this.height + "\" style=\"vertical-align:middle;\">\n");
		sb.append("<param name=\"quality\" value=\"high\">\n");
		sb.append("<param name=\"wmode\" value=\"transparent\">\n");
		sb.append("<param name=\"allowScriptAccess\" value=\"always\">\n");
		sb.append("<param name=\"FlashVars\" value=\"" + FlashVars + "\">\n");
