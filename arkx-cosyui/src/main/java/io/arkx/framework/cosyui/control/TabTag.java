...
public class TabTag extends ArkTag {
    ...
    public int doStartTag() throws TemplateRuntimeException {
        ...
        context.getOut().write("<table id=" + getId()
                + " width=\"100%\" height=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" ztype=\"tab_table\" class=\"js_layoutTable\">");
        context.getOut()
                .write("<tr><td height=\"37\" ztype=\"tab_thead\" valign=\"top\" style=\"_position:relative\">");
