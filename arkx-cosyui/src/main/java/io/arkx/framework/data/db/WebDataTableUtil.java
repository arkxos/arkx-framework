...
public class WebDataTableUtil extends DataTableUtil {
    ...
    public static void prepareHtmlTableToExcel(OutputStream os, DataGridAction dga, String rowTotal,
            String excelPageFlag, String pageIndex, String pageSize, String pageFlag, String method, String rest,
            String xls, String strIndexes, String strRows, String strWidths, int pageLimit) {
        try {
            Workbook wb = null;
            if ("2007".equals(Config.getExcelVersion())) {
                wb = new XSSFWorkbook();
