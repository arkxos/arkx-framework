...
public class Token implements java.io.Serializable {
	...
	/**
	 * An optional attribute value of the Token. Tokens which are not used as syntactic
	 * sugar will often contain meaningful values that will be used later on by the
	 * compiler or interpreter. This attribute value is often different from the image.
	 ...
	 * case MyParserConstants.ID : return new IDToken(ofKind, image); to the following
...
/*
 * JavaCC - OriginalChecksum=8323c9c093ab1e10072a0e9941ea76db (do not edit this line)
 */
