...
/**
 * @class org.ark.framework.utility.HtmlUtil html辅助工具类
 * @author Darkness
...
public class HtmlUtil {
	 ...
	 * blankFlag为true表示当DataTable中未有对应列时保留占位符 spaceFlag为true表示当DataTable中未有对应列时替换成空格
	 */
	...
	/**
	 * 用DataRow将一段HTML替换,spaceFlag为true表示当DataTable中未有对应列时替换成空格,匹配形如${FieldName} 的字符串
	 */
