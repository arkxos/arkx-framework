...
public class Html2Util {
    ...
    public static String mapxToCheckboxesTable(String name, Mapx<?, ?> map, Object[] checkedArray,
    ...
    public static String codeToCheckboxesTable(String name, String CodeType, DataTable checkedDT,
            Object[] disabledValue, int colNum) {
    ...
    public static String replacePlaceHolder(String html, PlaceHolderContext context, boolean blankFlag,
            boolean spaceFlag) {
        Matcher matcher = Constant.PatternField.matcher(html);
        StringBuilder sb = new StringBuilder();
        int lastEndIndex = 0;
