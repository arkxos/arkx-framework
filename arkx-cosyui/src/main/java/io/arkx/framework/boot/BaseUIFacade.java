...
/**
 * @class org.ark.framework.jaf.BaseUIFacade Entity UI Facade基类
 * @author Darkness
...
public abstract class BaseUIFacade<T extends Entity> extends UIFacade {
    ...
    /**
     * 表格查询调用 String simpleSearchValue =
     * searchParams.getString("simpleSearchValue");
     *
     * criteria.add( Restrictions.or( Restrictions.like(Project.Name,
     * simpleSearchValue), Restrictions.like(Project.DeviceName,
     * simpleSearchValue)));
     *
