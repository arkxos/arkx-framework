...
public class SystemController {
	...
	public SystemController(SystemInfoService systemInfoService,
							SystemMonitor systemMonitor, MonitorConfig monitorConfig) {
	 ...
	 * 系统性能指标
	 * 包括请求统计、队列状态、资源使用率等
	 * 包括请求统计、队列统计、CPU使用率、内存使用率、采样率、负载得分
	 */
	@GetMapping("/performance")
	public Map<String, Object> getPerformanceMetrics() {
		return Map.of(
				"requestStats", systemMonitor.getRequestStats(),
				"queueStats", systemMonitor.getQueueStats(),
				"cpuUsage", systemMonitor.getAverageCpuUsage(),
				"memoryUsage", systemMonitor.getAverageMemoryUsage(),
				"samplingRate", monitorConfig.getSamplingRate(),
				"loadScore", systemMonitor.getSystemLoadScore()
		);
	}
