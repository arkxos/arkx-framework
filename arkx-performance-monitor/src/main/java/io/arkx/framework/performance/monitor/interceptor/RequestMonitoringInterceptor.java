...
public class RequestMonitoringInterceptor implements HandlerInterceptor {
	...
	@Autowired
	public RequestMonitoringInterceptor(RequestLifecycleManager lifecycleManager, SystemMonitor systemMonitor) {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
		...
		// //ResourceHttpRequestHandler handlerMethod =
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler,
		...
		if (startProcessingTime != null) {
			...
			// 计算延迟（从接收到开始处理的时间）
			long latency = requestReceivedTime != null ? startProcessingTime - requestReceivedTime : 0;
