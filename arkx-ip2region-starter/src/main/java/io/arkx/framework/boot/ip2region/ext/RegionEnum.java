...
/**
 * Region 国家地区枚举 http://doc.chacuo.net/iso-3166-1 https://en.wikipedia.org/wiki/ISO_3166-1
 */
public enum RegionEnum {
	...
	BH("048", "BH", "BHR", "ISO 3166-2:BH", "Bahrain", "巴林"), BI("108", "BI", "BDI", "ISO 3166-2:BI", "Burundi", "布隆迪"),
	BJ("204", "BJ", "BEN", "ISO 3166-2:BJ", "Benin", "贝宁"),
	BL("652", "BL", "BLM", "ISO 3166-2:BL", "Saint Barthélemy", "圣巴泰勒米"),
	BM("060", "BM", "BMU", "ISO 3166-2:BM", "Bermuda", "百慕大"), BN("096", "BN", "BRN", "ISO 3166-2:BN", "Brunei", "文莱"),
	...
	BZ("084", "BZ", "BLZ", "ISO 3166-2:BZ", "Belize", "伯利兹"), CA("124", "CA", "CAN", "ISO 3166-2:CA", "Canada", "加拿大"),
	...
	CL("152", "CL", "CHL", "ISO 3166-2:CL", "Chile", "智利"), CM("120", "CM", "CMR", "ISO 3166-2:CM", "Cameroon", "喀麦隆"),
	CN("156", "CN", "CHN", "ISO 3166-2:CN", "China", "中国"), CO("170", "CO", "COL", "ISO 3166-2:CO", "Colombia", "哥伦比亚"),
	CR("188", "CR", "CRI", "ISO 3166-2:CR", "Costa Rica", "哥斯达黎加"),
	CU("192", "CU", "CUB", "ISO 3166-2:CU", "Cuba", "古巴"), CV("132", "CV", "CPV", "ISO 3166-2:CV", "Cape Verde", "佛得角"),
	...
	EE("233", "EE", "EST", "ISO 3166-2:EE", "Estonia", "爱沙尼亚"), EG("818", "EG", "EGY", "ISO 3166-2:EG", "Egypt", "埃及"),
	...
	FI("246", "FI", "FIN", "ISO 3166-2:FI", "Finland", "芬兰"), FJ("242", "FJ", "FJI", "ISO 3166-2:FJ", "Fiji", "斐济"),
	...
	FR("250", "FR", "FRA", "ISO 3166-2:FR", "France", "法国"), GA("266", "GA", "GAB", "ISO 3166-2:GA", "Gabon", "加蓬"),
	...
	GG("831", "GG", "GGY", "ISO 3166-2:GG", "Guernsey", "根西岛"), GH("288", "GH", "GHA", "ISO 3166-2:GH", "Ghana", "加纳"),
	GI("292", "GI", "GIB", "ISO 3166-2:GI", "Gibraltar", "直布罗陀"),
	GL("304", "GL", "GRL", "ISO 3166-2:GL", "Greenland", "格陵兰"),
	GM("270", "GM", "GMB", "ISO 3166-2:GM", "Gambia", "冈比亚"), GN("324", "GN", "GIN", "ISO 3166-2:GN", "Guinea", "几内亚"),
	...
	GT("320", "GT", "GTM", "ISO 3166-2:GT", "Guatemala", "危地马拉"), GU("316", "GU", "GUM", "ISO 3166-2:GU", "Guam", "关岛"),
	...
	HM("334", "HM", "HMD", "ISO 3166-2:HM", "Heard Island and McDonald Islands", "赫德岛和麦克唐纳群岛"), // no
																								// ip
	HN("340", "HN", "HND", "ISO 3166-2:HN", "Honduras", "洪都拉斯"),
	HR("191", "HR", "HRV", "ISO 3166-2:HR", "Croatia", "克罗地亚"), HT("332", "HT", "HTI", "ISO 3166-2:HT", "Haiti", "海地"),
	HU("348", "HU", "HUN", "ISO 3166-2:HU", "Hungary", "匈牙利"),
	ID("360", "ID", "IDN", "ISO 3166-2:ID", "Indonesia", "印度尼西亚"),
	IE("372", "IE", "IRL", "ISO 3166-2:IE", "Ireland", "爱尔兰"), IL("376", "IL", "ISR", "ISO 3166-2:IL", "Israel", "以色列"),
	...
	IQ("368", "IQ", "IRQ", "ISO 3166-2:IQ", "Iraq", "伊拉克"), IR("364", "IR", "IRN", "ISO 3166-2:IR", "Iran", "伊朗"),
	IS("352", "IS", "ISL", "ISO 3166-2:IS", "Iceland", "冰岛"), IT("380", "IT", "ITA", "ISO 3166-2:IT", "Italy", "意大利"),
	JE("832", "JE", "JEY", "ISO 3166-2:JE", "Jersey", "泽西岛"), JM("388", "JM", "JAM", "ISO 3166-2:JM", "Jamaica", "牙买加"),
	JO("400", "JO", "JOR", "ISO 3166-2:JO", "Jordan", "约旦"), JP("392", "JP", "JPN", "ISO 3166-2:JP", "Japan", "日本"),
	...
	LA("418", "LA", "LAO", "ISO 3166-2:LA", "Laos", "老挝"), LB("422", "LB", "LBN", "ISO 3166-2:LB", "Lebanon", "黎巴嫩"),
	...
	LV("428", "LV", "LVA", "ISO 3166-2:LV", "Latvia", "拉脱维亚"), LY("434", "LY", "LBY", "ISO 3166-2:LY", "Libya", "利比亚"),
	MA("504", "MA", "MAR", "ISO 3166-2:MA", "Morocco", "摩洛哥"), MC("492", "MC", "MCO", "ISO 3166-2:MC", "Monaco", "摩纳哥"),
	...
	MN("496", "MN", "MNG", "ISO 3166-2:MN", "Mongolia", "蒙古"), MO("446", "MO", "MAC", "ISO 3166-2:MO", "Macao", "中国澳门"),
	...
	MW("454", "MW", "MWI", "ISO 3166-2:MW", "Malawi", "马拉维"), MX("484", "MX", "MEX", "ISO 3166-2:MX", "Mexico", "墨西哥"),
	...
	NO("578", "NO", "NOR", "ISO 3166-2:NO", "Norway", "挪威"), NP("524", "NP", "NPL", "ISO 3166-2:NP", "Nepal", "尼泊尔"),
	NR("520", "NR", "NRU", "ISO 3166-2:NR", "Nauru", "瑙鲁"), NU("570", "NU", "NIU", "ISO 3166-2:NU", "Niue", "纽埃"),
	NZ("554", "NZ", "NZL", "ISO 3166-2:NZ", "New Zealand", "新西兰"),
	OM("512", "OM", "OMN", "ISO 3166-2:OM", "Oman", "阿曼"), PA("591", "PA", "PAN", "ISO 3166-2:PA", "Panama", "巴拿马"),
	...
	PT("620", "PT", "PRT", "ISO 3166-2:PT", "Portugal", "葡萄牙"), PW("585", "PW", "PLW", "ISO 3166-2:PW", "Palau", "帕劳"),
	PY("600", "PY", "PRY", "ISO 3166-2:PY", "Paraguay", "巴拉圭"), QA("634", "QA", "QAT", "ISO 3166-2:QA", "Qatar", "卡塔尔"),
	...
	SD("729", "SD", "SDN", "ISO 3166-2:SD", "Sudan", "苏丹"), SE("752", "SE", "SWE", "ISO 3166-2:SE", "Sweden", "瑞典"),
	...
	SJ("744", "SJ", "SJM", "ISO 3166-2:SJ", "Template:Country data SJM Svalbard", "斯瓦尔巴群岛和扬马延岛"), // no
																									// ip
	...
	TF("260", "TF", "ATF", "ISO 3166-2:TF", "French Southern Territories", "法属南部领地"), // no
																						// ip
	TG("768", "TG", "TGO", "ISO 3166-2:TG", "Togo", "多哥"), TH("764", "TH", "THA", "ISO 3166-2:TH", "Thailand", "泰国"),
	...
	TN("788", "TN", "TUN", "ISO 3166-2:TN", "Tunisia", "突尼斯"), TO("776", "TO", "TON", "ISO 3166-2:TO", "Tonga", "汤加"),
	TR("792", "TR", "TUR", "ISO 3166-2:TR", "Turkey", "土耳其"),
	TT("780", "TT", "TTO", "ISO 3166-2:TT", "Trinidad & Tobago", "特立尼达和多巴哥"),
	TV("798", "TV", "TUV", "ISO 3166-2:TV", "Tuvalu", "图瓦卢"), TW("158", "TW", "TWN", "ISO 3166-2:TW", "Taiwan", "中国台湾"),
	TZ("834", "TZ", "TZA", "ISO 3166-2:TZ", "Tanzania", "坦桑尼亚"),
	UA("804", "UA", "UKR", "ISO 3166-2:UA", "Ukraine", "乌克兰"), UG("800", "UG", "UGA", "ISO 3166-2:UG", "Uganda", "乌干达"),
	UM("581", "UM", "UMI", "ISO 3166-2:UM", "United States Minor Outlying Islands", "美国本土外小岛屿"), // no
																									// ip
	...
	WS("882", "WS", "WSM", "ISO 3166-2:WS", "Samoa", "萨摩亚"), YE("887", "YE", "YEM", "ISO 3166-2:YE", "Yemen", "也门"),
	...
	UK("998", "UK", "UNKNOWN", "", "Unknown", "未知国家/地区"), TS("999", "TS", "TEST", "", "Test", "测试"),
	...
	public static boolean isChinaRegion(RegionEnum region) {
		return RegionEnum.CN.equals(region) || RegionEnum.HK.equals(region) || RegionEnum.MO.equals(region)
				|| RegionEnum.TW.equals(region);
	}
	...
	public boolean isChinaRegion() {
		return RegionEnum.CN.equals(this) || RegionEnum.HK.equals(this) || RegionEnum.MO.equals(this)
				|| RegionEnum.TW.equals(this);
	}
