...
public class LogServiceImpl implements LogService {
    ...
    public void save(String username, String browser, String ip, ProceedingJoinPoint joinPoint, Log log) {
        ...
        com.rapidark.framework.common.annotation.Log aopLog = method.getAnnotation(com.rapidark.framework.common.annotation.Log.class);
    ...
    public Object findByErrDetail(Long id) {
        ...
        com.rapidark.framework.common.utils.ValidationUtil.isNull(log.getId(), "Log", "id", id);
