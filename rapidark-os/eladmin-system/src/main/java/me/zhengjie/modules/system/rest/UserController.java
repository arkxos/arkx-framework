...
import com.rapidark.common.utils.enums.CodeEnum;
...
public class UserController {
    ...
    public ResponseEntity<Object> query(UserQueryCriteria criteria, Pageable pageable){
        ...
        // 数据权限
        List<Long> dataScopes = dataService.getDeptIds(userService.findByName(com.rapidark.common.utils.SecurityUtils.getCurrentUsername()));
    ...
    public ResponseEntity<Object> center(@Validated(User.Update.class) @RequestBody User resources){
        if(!resources.getId().equals(com.rapidark.common.utils.SecurityUtils.getCurrentUserId())){
    ...
    public ResponseEntity<Object> delete(@RequestBody Set<Long> ids){
        for (Long id : ids) {
            Integer currentLevel =  Collections.min(roleService.findByUsersId(com.rapidark.common.utils.SecurityUtils.getCurrentUserId()).stream().map(RoleSmallDto::getLevel).collect(Collectors.toList()));
    ...
    public ResponseEntity<Object> updatePass(@RequestBody UserPassVo passVo) throws Exception {
        ...
        UserDto user = userService.findByName(com.rapidark.common.utils.SecurityUtils.getCurrentUsername());
    ...
    public ResponseEntity<Object> updateEmail(@PathVariable String code,@RequestBody User user) throws Exception {
        ...
        UserDto userDto = userService.findByName(com.rapidark.common.utils.SecurityUtils.getCurrentUsername());
