...
export const updateRoute = data => {
    return request({
        url: '/gatewayManage/route/update',
        method: 'post',
        data
    })
};
...
export const routePageList = data => {
    return request({
        url: '/gatewayManage/route/pageList',
        method: 'post',
        data
    })
};
...
export const deleteRoute = data => {
    return request({
        url: '/gatewayManage/route/delete',
        method: 'get',
        data
    })
};
