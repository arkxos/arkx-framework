    ...
    <Modal v-model="modalVisible"
      ...
      <div>
        <Form ref="form1" v-show="current=='form1'" :model="formItem" :rules="formItemRules" :label-width="100">
          <FormItem label="前端应用">
            <Input disabled v-model="value.serviceId"/>
          </FormItem>
          <FormItem label="上级菜单">
            <Input disabled v-model="value.menuName"/>
          </FormItem>
          <FormItem label="功能标识" prop="actionCode">
            <Input v-model="formItem.actionCode" placeholder="请输入内容"/>
            <span>菜单标识+自定义标识.默认后缀：View、Edit</span>
          </FormItem>
          <FormItem label="功能名称" prop="actionName">
            <Input v-model="formItem.actionName" placeholder="请输入内容"/>
          </FormItem>
          <FormItem label="优先级">
          ...
          <FormItem label="描述">
            <Input v-model="formItem.actionDesc" type="textarea" placeholder="请输入内容"/>
          </FormItem>
        </Form>
