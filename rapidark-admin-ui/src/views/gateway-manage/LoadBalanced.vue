...
<script>
	...
	import {balancedPageList,deleteBalanced,startBalanced,stopBalanced} from '@/api/gateway-manage/balanced_api.js'
	import {loadServerRegList} from '@/api/gateway-manage/balanced_api.js'
