<template>
  <div>
    <leftTree menu-type="position" @changeData="changeData"/>
    <div>
      ...
      <Modal v-model="popup" footer-hide :title="title">
        <Form :model="formItem" :label-width="80" :rules="ruleValidate" class="form" ref="formItem">
          <FormItem label="岗位名称" prop="positionName">
            <Input v-model="formItem.positionName"/>
          </FormItem>
          <FormItem label="岗位代码" prop="positionCode">
            <Input v-model="formItem.positionCode"/>
          </FormItem>
          ...
          <FormItem label="显示顺序" prop="seq">
            <Input v-model="formItem.seq"/>
          </FormItem>
          <FormItem label="工作内容" prop="workContent">
            <Input type="textarea" v-model="formItem.workContent"/>
          </FormItem>
          <FormItem label="工作标准" prop="workStandard">
            <Input type="textarea" v-model="formItem.workStandard"/>
          </FormItem>
          <FormItem label="责任权重" prop="responsibilityWeight">
            <Input type="textarea" v-model="formItem.responsibilityWeight"/>
          </FormItem>
          <FormItem label="所需资格条件" prop="requiredQualifications">
            <Input type="textarea" v-model="formItem.requiredQualifications"/>
          </FormItem>
          <div class="btnDev">
