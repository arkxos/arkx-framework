<template>
  <div>
    ...
    <Modal :title="title" v-model="popup" footer-hide width="750" class="popupForm">
      <div class="title">
        <span :class="isbgcolor==1?'bgcolor':''">基础信息</span>
        <span :class="isbgcolor==2?'bgcolor':''">联系信息</span>
      </div>
          ...
          <div class="clearfix">
            <div class="left">
              ...
              <FormItem label="显示顺序" prop="payer">
                <Input v-model="formItem.payer"/>
              </FormItem>
              <FormItem label="企业英文名" prop="companyNameEn">
                <Input v-model="formItem.companyNameEn"/>
              </FormItem>
              <FormItem label="企业性质" prop="natureId">
                <Input v-model="formItem.natureId"/>
              </FormItem>
              <FormItem label="所在区域" prop="areaId">
                <Input v-model="formItem.areaId"/>
              </FormItem>
              ...
              <FormItem label="注册资金" prop="registeredCapital">
                <Input v-model="formItem.registeredCapital"/>
              </FormItem>
              <FormItem label="员工人数" prop="staffNum">
                <Input v-model="formItem.staffNum"/>
              </FormItem>
              <FormItem label="公司网址" prop="website">
                <Input v-model="formItem.website"/>
              </FormItem>
              <FormItem label="公司介绍" prop="profile">
                <Input v-model="formItem.profile" type="textarea"/>
              </FormItem>
            </div>
            <div class="right">
              <div class="imgBox">
