<template>
  <div>
    <leftTree menu-type="staff" @changeData="changeData" @searchStaff="changeStaffInfo"/>
    <div>
      <Form :label-width="0" inline :model="staffInfo">
        <FormItem prop="name">
          <Input v-model="staffInfo.name" placeholder="输入员工姓名" style="width:150px;"/>
        </FormItem>
        <FormItem prop="mobile">
          <Input v-model="staffInfo.mobile" placeholder="输入手机号码"  style="width:150px;"/>
        </FormItem>
        <FormItem>
          ...
          <div class="clearfix">
            <div class="left">
              ...
              <FormItem label="企业邮箱" prop="orgEmail">
                <Input v-model="formItem.orgEmail"/>
              </FormItem>
              <FormItem label="员工工号" prop="jobnumber">
                <Input v-model="formItem.jobnumber"/>
              </FormItem>
              ...
              <FormItem label="办公地点" prop="workPlace">
                <Input v-model="formItem.workPlace"/>
              </FormItem>
      ...
      <Modal v-model="modalVisible" title="设置管理员信息" footer-hide>
        <Form ref="adminForm" :model="adminForm" :rules="formItemRules" :label-width="100">
          ...
          <FormItem label="昵称" prop="nickName">
            <Input v-model="adminForm.nickName" placeholder="请输入内容"/>
          </FormItem>
          <FormItem label="登录名" prop="userName">
            <Input v-model="adminForm.userName" placeholder="请输入内容"/>
          </FormItem>
          <FormItem label="登录密码" prop="password">
            <Input type="password" v-model="adminForm.password" placeholder="请输入内容"/>
          </FormItem>
          <FormItem label="再次确认密码" prop="passwordConfirm">
            <Input type="password" v-model="adminForm.passwordConfirm" placeholder="请输入内容"/>
          </FormItem>
          <FormItem label="邮箱" prop="email">
            <Input v-model="adminForm.email" placeholder="请输入内容"/>
          </FormItem>
          <FormItem label="手机号" prop="mobile">
            <Input v-model="adminForm.mobile" placeholder="请输入内容"/>
          </FormItem>
          <FormItem label="状态">
          ...
          <FormItem label="描述">
            <Input v-model="adminForm.userDesc" type="textarea" placeholder="请输入内容"/>
          </FormItem>
          <div class="btnDev">
...
import leftTree from '@/views/organization/components/leftTree'
export default {
  components: {
    leftTree
  },
