            ...
            <Form ref="form1" v-show="current=='form1'" :model="formItem" :rules="formItemRules" :label-width="100">
              ...
              <FormItem label="策略类型" prop="policyType">
                <Select v-model="formItem.policyType">
                  <Option value="0" label="拒绝-黑名单"/>
                  <Option value="1" label="允许-白名单"/>
                </Select>
              </FormItem>
              <FormItem label="IP地址/域名" prop="ipAddress">
                <Input v-model="formItem.ipAddress" type="textarea" placeholder="192.168.0.1;192.168.0.2;baidu.com;weixin.com"/> 同时支持Ip和域名,多个用分号";"隔开。示例：192.168.0.1;baidu.com;weixin.com
              </FormItem>
            </Form>
          </TabPane>
