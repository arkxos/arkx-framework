            ...
            <Form ref="form1" v-show="current=='form1'" :model="formItem" :rules="formItemRules" :label-width="100">
              ...
              <FormItem label="策略类型" prop="policyType">
                <Select v-model="formItem.policyType">
                  <Option value="url" label="接口(url)"/>
                  <Option disabled value="origin" label="来源(origin)"/>
                  <Option disabled value="user" label="用户(user)"/>
                </Select>
              </FormItem>
              <FormItem label="单位时间" prop="intervalUnit">
                <Select v-model="formItem.intervalUnit">
                  <Option value="seconds" label="秒(seconds)"/>
                  <Option value="minutes" label="分钟(minutes)"/>
                  <Option value="hours" label="小时(hours)"/>
                  <Option value="days" label="天(days)"/>
                </Select>
              </FormItem>
              <FormItem label="限流数" prop="limitQuota">
                <InputNumber :min="10" v-model="formItem.limitQuota"/>
              </FormItem>
            </Form>
          </TabPane>
