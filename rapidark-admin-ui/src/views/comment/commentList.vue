  ...
  <div class="comment-list padding16">
      <Form ref="searchForm" :model="searchForm" class="selector-wrapper clearfix" :label-width="70" inline>
        ...
        <FormItem class="right-input" :label-width="0" label="">
          <Input style="width:105px;" v-model="searchForm.searchContent" placeholder="商品名称/用户名"/>
        </FormItem>
    ...
    <Modal
        ...
        @on-ok="ok"
        @on-cancel="cancel">
        <Table border ref="selection2" @on-selection-change='selectChange2' :columns="replyInfoDataColumns" :data="replyInfoData"/>
    </Modal>
  </div>
</template>
