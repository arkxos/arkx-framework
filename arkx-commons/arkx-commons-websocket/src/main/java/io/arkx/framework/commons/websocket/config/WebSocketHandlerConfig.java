...
import io.arkx.framework.commons.websocket.custom.ArkxSessionKeyGenerator;
import io.arkx.framework.commons.websocket.custom.UserAttributeHandshakeInterceptor;
import io.arkx.framework.commons.websocket.handler.CustomPlanTextMessageHandler;
import io.arkx.framework.commons.websocket.handler.CustomWebSocketHandler;
import io.arkx.framework.commons.websocket.handler.PingJsonMessageHandler;
import io.arkx.framework.commons.websocket.handler.PlanTextMessageHandler;
import io.arkx.framework.commons.websocket.holder.MapSessionWebSocketHandlerDecorator;
import io.arkx.framework.commons.websocket.holder.SessionKeyGenerator;
...
public class WebSocketHandlerConfig {
    ...
    public SessionKeyGenerator sessionKeyGenerator() {
        return new ArkxSessionKeyGenerator();
    }
