 ...
 * 用户属性握手拦截器
 * <p>
 * 在 WebSocket 握手阶段，将当前通过 Spring Security 认证的用户信息存入 WebSocket 会话属性中， 以便后续在
 * WebSocket 处理流程中访问用户信息。
 * </p>
 *
 * @author lengleng
 * @date 2021/10/4
...
public class UserAttributeHandshakeInterceptor implements HandshakeInterceptor {
    ...
    public boolean beforeHandshake(ServerHttpRequest request, ServerHttpResponse response, WebSocketHandler wsHandler,
        ...
        // ArkUser user = SecurityUtils.getUser();
