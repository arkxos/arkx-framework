...
// * @date 2020/6/9
// */
//public final class ArkSentinelFeign {
//
//	private ArkSentinelFeign() {
//
//	}
//
//	public static ArkSentinelFeign.Builder builder() {
//		return new ArkSentinelFeign.Builder();
//	}
//
...
//
//		@Override
//		public ArkSentinelFeign.Builder contract(Contract contract) {
...
//						return new ArkSentinelInvocationHandler(target, dispatch,
...
//						return new ArkSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
//					}
//					return new ArkSentinelInvocationHandler(target, dispatch);
//				}
//
...
//
//}
package io.arkx.cloud.platform.common.feign.sentinel.ext;
