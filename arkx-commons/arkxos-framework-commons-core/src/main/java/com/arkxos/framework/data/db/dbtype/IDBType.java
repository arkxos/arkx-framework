...
import com.arkxos.framework.data.db.command.DropColumnCommand;
...
public interface IDBType extends IExtendItem {
	 ...
	 * @param dataType 数据类型
	 */
	Object getValueFromResultSet(ResultSet rs, int columnIndex, DataTypes dataType, boolean latin1Flag) throws SQLException;
