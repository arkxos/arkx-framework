 ...
 * https://github.com/baidu/uid-generator/blob/master/README.zh_cn.md 以下为可选配置，若未配置将采用默认值
 *
...
public class UidGeneratorProperties {
	...
	/**
	 * boostPower：RingBuffer size扩容参数, 可提高UID生成的吞吐量 默认为3，原bufferSize=8192, 扩容后 bufferSize=
	 * 8192 << 3 = 65536
	 */
