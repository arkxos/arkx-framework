...
### 步骤3: 修改Spring配置
提供了两种生成器: [DefaultUidGenerator](src/main/java/io/arkx/framework/commons/uid/impl/DefaultUidGenerator.java)、[CachedUidGenerator](src/main/java/io/arkx/framework/commons/uid/impl/CachedUidGenerator.java)。如对UID生成性能有要求, 请使用CachedUidGenerator<br/>
...
```xml
<!-- DefaultUidGenerator -->
<bean id="defaultUidGenerator" class="impl.io.arkx.framework.commons.uid.DefaultUidGenerator" lazy-init="false">
...
<bean id="disposableWorkerIdAssigner" class="worker.io.arkx.framework.commons.uid.DisposableWorkerIdAssigner"/>
...
```xml
<!-- CachedUidGenerator -->
<bean id="cachedUidGenerator" class="impl.io.arkx.framework.commons.uid.CachedUidGenerator">
    <property name="workerIdAssigner" ref="disposableWorkerIdAssigner"/>
...
```xml
<!-- Spring annotation扫描 -->
<context:component-scan base-package="io.arkx.uid" />
...
<bean class="org.mybatis.spring.mapper.MapperScannerConfigurer">
	...
	<property name="basePackage" value="io.arkx.uid.worker.dao" />
