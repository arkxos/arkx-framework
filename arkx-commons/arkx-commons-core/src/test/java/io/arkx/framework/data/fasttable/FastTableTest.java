...
public class FastTableTest {
    ...
    public static void main(String[] args) {
        ...
        // create
        FastTable fastTable = new FastTableBuilder().tableName(TEST_TABLE_NAME).addDateColumn("date")
                .addStringColumn("string", 20).addFixedStringColumn("fixedstring", 6).addIntColumn("int")
                .addFloatColumn("float").addDoubleColumn("double").addLongColumn("long").create(SystemInfo.userDir()
                        + File.separator + "temp" + File.separator + UuidUtil.base58Uuid() + ".aft");
