...
public class SyncSummary {
	...
	public String getSummary() {
		...
		sb.append("同步任务汇总: 总表数=")
			.append(totalTables.get())
			.append(", 成功=")
			.append(successTables.get())
			.append(", 失败=")
			.append(failedTables.get())
			.append(", 数据不一致=")
			.append(inconsistentTables.get())
			.append(", 总记录数=")
			.append(totalRecordsProcessed.get())
			.append(", 成功率=")
			.append(String.format("%.2f%%", getSuccessRate()))
			.append(", 总耗时=")
			.append(getTotalDurationMs())
			.append("毫秒");
