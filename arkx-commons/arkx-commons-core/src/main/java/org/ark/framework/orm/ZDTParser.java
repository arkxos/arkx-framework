	...
	protected static DataTable parseDataTable(ZDTTableInfo ti, String data) {
		...
		label545: for (String str : arr) {
			...
			for (String v : arr2) {
				...
				else if (ObjectUtil.in(new Object[] { Integer.valueOf(scs[i].getColumnType()), Integer.valueOf(8),
						Integer.valueOf(9) }))
				...
				else if (ObjectUtil.in(new Object[] { Integer.valueOf(scs[i].getColumnType()), Integer.valueOf(6),
						Integer.valueOf(4) }))
