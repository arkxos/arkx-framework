...
/**
 * @class org.ark.framework.ssi.ResponseIncludeWrapper
 * @author Darkness
 * @date 2013-1-31 下午12:33:27
 * @version V1.0
 */
public class ResponseIncludeWrapper extends HttpServletResponseWrapper {
	...
	public ResponseIncludeWrapper(ServletContext context, HttpServletRequest request, HttpServletResponse response,
		...
		if (this.servletOutputStream == null) {
			if (this.printWriter == null) {
				...
				this.printWriter = new PrintWriter(
						new OutputStreamWriter(this.captureServletOutputStream, getCharacterEncoding()));
			}
	...
	public void addHeader(String name, String value) {
		...
		if (lname.equals("last-modified"))
			try {
				this.lastModified = DateTool.rfc1123Format.parse(value).getTime();
			}
