...
public class Tab {
	...
	public String getHtml() {
		...
		sb.append("<table width=\"100%\" height=\""+getHeight()+"\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" id=\"js_layoutTable\" class=\"js_layoutTable\">");
		...
		if (ObjectUtil.notEmpty(children)) {
			...
			for (String[] arr : children) {
				...
				if("iframe".equals(displayType)) {
					if (id.equals(selectedID)) {
						sb.append("<iframe ").append(src).append(" width=\"100%\" height=\"100%\" style=\"position:static;left:-22in;top:-11in;\" id=\"_ChildTabFrame_").append(id)
						...
						sb.append(src).append(" width='100%' height='100%' style=\"position:absolute;left:-22in;top:-11in;\" id=\"_ChildTabFrame_").append(id)
								.append("\" frameborder=\"0\" scrolling=\"auto\" allowtransparency=\"true\"></iframe>");
					}
				} else {
					if (id.equals(selectedID)) {
						sb.append("<div style='position:static;left:-22in;top:-11in;' id='_ChildTabFrame_"
								+ id
								+ "'>"
								+ childTabContent + "</div>");
					} else {
						sb.append("<div style=\'position:absolute;left:-22in;top:-11in;\' id='_ChildTabFrame_"
								+ id
			...
			script.setInnerHTML("Ark.Page.onReady(function(){Ark.TabPage.init(\"_ChildTabFrame_" + selectedID + "\");},5);");
