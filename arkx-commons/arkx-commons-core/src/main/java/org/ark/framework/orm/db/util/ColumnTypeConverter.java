...
/**
 * 数据库列类型转换工具类
 * 提供数据库列类型转换和处理的通用方法，包括字段类型转换、长度阈值检查等功能
 */
public class ColumnTypeConverter {
     ...
     *
     * @param column 列信息
     * @param defaultVarcharType 默认VARCHAR类型名称（不同数据库可能不同）
     * @param textType 对应的TEXT类型名称（不同数据库可能不同）
     * @return 适合的SQL类型名称
     */
     ...
     *
     * @param column 列信息
     * @param defaultVarcharType 默认VARCHAR类型名称
     * @param textType 对应的TEXT类型名称
     * @return 完整的SQL类型声明
     */
