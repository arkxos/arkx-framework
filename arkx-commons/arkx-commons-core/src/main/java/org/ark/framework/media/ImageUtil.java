...
public class ImageUtil {
    ...
    public static void pressText(String filePath, String pressText, Font font, Color color, Color outlineColor,
        ...
        int[] xy = getPosition(filePath, pressText, font.getSize(), position);
        if (existsGraphicsMagick())
            ImageMagickUtil.pressText(filePath, pressText, font, color, outlineColor, outlineSize, opicty, xy[0],
                    xy[1]);
        else
            SimpleImageUtil.pressText(filePath, pressText, font, color, outlineColor, outlineSize, opicty, xy[0],
                    xy[1]);
    }
    ...
    public static void pressText(String filePath, String pressText, Font font, Color color, Color outlineColor,
            int outlineSize, float opicty, int x, int y) throws Exception {
        if (existsGraphicsMagick())
