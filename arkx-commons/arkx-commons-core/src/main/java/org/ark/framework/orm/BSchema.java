...
// protected static final String _InsertAllSQL = "insert into pt_org__branch
// values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
// protected static final String _UpdateAllSQL = "update pt_org__branch set
// BranchInnerCode=?,BranchCode=?,ParentInnerCode=?,Type=?,OrderFlag=?,Name=?,TreeLevel=?,IsLeaf=?,Phone=?,Fax=?,Manager=?,Leader1=?,Leader2=?,Prop1=?,Prop2=?,Prop3=?,Prop4=?,Memo=?,AddTime=?,AddUser=?,ModifyTime=?,ModifyUser=?
// where BranchInnerCode=?";
// protected static final String _DeleteSQL = "delete from pt_org__branch where
// BranchInnerCode=?";
// protected static final String _FillAllSQL = "select * from pt_org__branch
// where BranchInnerCode=?";
//
...
// sb.append(this.InsertAllSQL.substring(index + this.schema.TableCode.length(),
// this.InsertAllSQL.length() - 1));
// sb.append(",?,?,?,?)");
...
// sb.append(this.UpdateAllSQL.substring(index + this.schema.TableCode.length(),
// this.UpdateAllSQL.lastIndexOf(" where ")));
// sb.append(",BackupNo=?");
...
// sb.append(this.DeleteSQL.substring(index + this.schema.TableCode.length(),
// this.DeleteSQL.lastIndexOf(" where ")));
// sb.append(pk);
...
// sb.append(this.FillAllSQL.substring(index + this.schema.TableCode.length(),
// this.FillAllSQL.lastIndexOf(" where ")));
// sb.append(pk);
...
// if (backupNo != null) {
// int len = StringUtil.lengthEx(backupNo,
// Config.getGlobalCharset().equals("UTF-8"));
// if (len > 15) {
// throw new RuntimeException("Data is too long, max is 15,actual is " + len +
// ":" + backupNo);
// }
// }
...
// int len = StringUtil.lengthEx(backupOperator,
// Config.getGlobalCharset().equals("UTF-8"));
// if (len > 50) {
// throw new RuntimeException("Data is too long, max is 50,actual is " + len +
// ":" + backupOperator);
// }
// }
...
// if (backupMemo != null) {
// int len = StringUtil.lengthEx(backupMemo,
// Config.getGlobalCharset().equals("UTF-8"));
// if (len > 200) {
// throw new RuntimeException("Data is too long, max is 200,actual is " + len +
// ":" + backupMemo);
// }
// }
