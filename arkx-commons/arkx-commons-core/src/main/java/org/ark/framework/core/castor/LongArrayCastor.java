    ...
    public Object cast(Object obj, Class<?> type) {
        ...
        if (obj.getClass().isArray()) {
            ...
            for (int i = 0; i < os.length; i++) {
                arr[i] = ((Long) LongCastor.getInstance().cast(os[i], type)).longValue();
            }
            return arr;
        }
        ...
        return new long[]{((Long) LongCastor.getInstance().cast(obj, type)).longValue()};
    }
}
