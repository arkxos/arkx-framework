...
/**
 * @class org.ark.framework.orm.connection.DBConfig 配置示例
 *        <database name="Default"> <Type>MYSQL</Type>
 *        <ServerAddress>localhost</ServerAddress> <Port>3306</Port>
 *        <Name>bbs</Name> <UserName>root</UserName>
 *        <Password>$KEYw//j8IH+fBtReFR4D88/Hw==</Password>
 *        <MaxConnCount>1000</MaxConnCount> <InitConnCount>0</InitConnCount>
 *        <TestTable>article</TestTable> </database>
 * @author Darkness
 * @version 1.0
 * @since JDF 1.0
 */
