...
public class RepositoryFactory {
    ...
    public static <TRepository extends IRepository<? extends Entity>> TRepository getRepository(
            Class<TRepository> repositoryClass, IUnitOfWork unitOfWork) {
        ...
        if (!repositories.containsKey(interfaceShortName)) {
            ...
            if (unitOfWork != null && repositoryType.isAssignableFrom(RepositoryBase.class)) {
                try {
                    repository = (TRepository) repositoryType.getConstructor(unitOfWork.getClass())
                            .newInstance(unitOfWork);
