...
//		}
	...
	public static void parseParameters(Map<String, Object> map, String data, String encoding) throws UnsupportedEncodingException {
	...
	public static void parseParameters(Map<String, Object> map, byte[] data, String encoding) throws UnsupportedEncodingException {
		if ((data != null) && (data.length > 0)) {
			int ix = 0;
			int ox = 0;
			String key = null;
