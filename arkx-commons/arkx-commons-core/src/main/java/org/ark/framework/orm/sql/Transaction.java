...
// this.dataAccess = new
// JdbcTemplate(ConnectionPoolManager.getConnection(getPoolName()));
// }
...
//// return false;
//// } else if (type == DELETE_AND_BACKUP) {
//// if (!SchemaRepository.deleteAndBackup(s, this.backupOperator,
// this.backupMemo))
//// return false;
//// } else if ((type == DELETE_AND_INSERT) &&
// (!SchemaRepository.deleteAndInsert(s))) {
//// return false;
//// }
// }
//
