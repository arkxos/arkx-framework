...
public class SqlHelper {
	...
	public static String getGlobalConnectionString() {
		...
		// {
		// if
		// (System.Configuration.ConfigurationSettings.AppSettings["GlobalConnectionString"]
		// == null)
		// {
		// strCn = "";
		// }
		...
		// System.Configuration.ConfigurationSettings.AppSettings["GlobalConnectionString"];
		// }
		// //throw new Exception("the GlobalConnectionString has not setted! You can't
		// use SqlHelper");
		// }
		// return strCn ;
		// }
	...
	// </param>
	/// <returns> returns an int representing the number of rows affected by the
	// command</returns>
	public static int executeNonQuery(String commandText) {
		return getSession().createQuery(commandText).executeNoQuery();
	}
	// #endregion
	...
	// #region GetPK
	/// <summary>
	/// Execute a SqlCommand (that returns an int number for the table's max ID for
	// insert)
	///
	/// e.g.:
	...
	/// <param name="columnName">columnName's name,the column must be the PK and not
	// an increment column</param>
	...
	// #region GetResultString(String commandText) 取得一单列多行结果，将结果用“,”号分隔返回一个字符串
	/// <summary>
	...
	// #endregion GetResultString(String commandText) 取得一单列多行结果，将结果用“,”号分隔返回一个字符串
