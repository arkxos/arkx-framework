...
public class ColInfo {
	...
	public ColInfo(String m_tablename, String m_name, int m_xtype, int m_length, int m_isnullable, int m_havedefault, int m_ispk, int m_isincrement, String m_remark, String m_default) {
	...
	public String getShowType() {

		{
			...
			if (getSqlType() == SqlTypes.TINYINT || getSqlType() == SqlTypes.INT || getSqlType() == SqlTypes.REAL || getSqlType() == SqlTypes.FLOAT || getSqlType() == SqlTypes.BIT
					|| getSqlType() == SqlTypes.DECIMAL || getSqlType() == SqlTypes.NUMERIC || getSqlType() == SqlTypes.BIGINT) {
