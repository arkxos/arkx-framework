...
public class SqlHelperBase {
	...
	public static int GetPK(String m_connectionString, String tableName, String columnName) {
		return Integer.parseInt(ExecuteScalar(m_connectionString, "select isnull(max(" + columnName + "),0)+1 as col from " + tableName).toString());
	}
	...
	public static int GetPK(String m_connectionString, String tableName, String columnName, int minValue, int maxValue) {
		return Integer.parseInt(ExecuteScalar(m_connectionString,
				"select isnull(max(" + columnName + ")," + (minValue - 1) + ")+1 as col from " + tableName + " where " + columnName + ">=" + minValue + " and " + columnName + "<" + maxValue)
				.toString());
	}
	...
	public static String GetIndexId(String m_connectionString, String tableName, String columnName, String m_where, int amplitude) {
		return ExecuteScalarString(m_connectionString, "select isnull(max(cast(" + columnName + " as bigint)),0)+" + amplitude + " as col from " + tableName + " where " + m_where);
	}
	...
	public static int DataRowCount(String m_connectionString, String tableName, String m_where) {
		return Integer.parseInt(ExecuteScalarString(m_connectionString, "select count(" + tableName + "." + TableStructList.Get(tableName).getPrimary().getName() + ") from " + tableName + " where "
				+ m_where));
	}
