...
public class DiskFileItemFactory implements FileItemFactory {
	...
	/**
	 * Returns the directory used to temporarily store files that are larger than the
	...
	/**
	 * Returns the size threshold beyond which files are written directly to disk. The
	...
	/**
	 * Create a new {@link DiskFileItem} instance from the supplied parameters and the
