...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// DownloadMission mission2 = new DownloadMission(file2, saveDirectory,
			// "test2");
			// downloadManager.addMission(mission2);
			// DownloadMission mission3 = new DownloadMission(file3, saveDirectory,
			// "test3");
			...
			while (true) {
				...
				System.out.println("Downloader information Speed:" + downloadEnginer.getReadableTotalSpeed()
						+ " Down Size:" + downloadEnginer.getReadableDownloadSize());
				Thread.sleep(1000);
				// counter++;
				// if (counter == 6) {
				// mission.pause();
