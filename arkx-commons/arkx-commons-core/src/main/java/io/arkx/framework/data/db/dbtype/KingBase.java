 ...
 * @version V1.0
 */
public class KingBase extends AbstractDBType {

    public final static String ID = "KINGBASE";
    ...
    public String getJdbcUrl(ConnectionConfig dcc) {
        ...
        sb.append("?currentSchema=public,pg_catalog,sys_catalog");
    ...
    public String getPagedSQL(String sql, int pageSize, int pageIndex, int connectionId) {
        ...
        q.append(" limit " + start + " offset " + pageSize);
        return q.toString();
    }
