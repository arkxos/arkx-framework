...
public class JdbcTemplate {
	...
	public static void setPreparedStatementParams(PreparedStatement stmt, ArrayList<Object> params, Connection conn)
			throws SQLException {
	...
	public static void setBatchParams(PreparedStatement stmt, List<ArrayList<Object>> batches, Connection conn)
			throws SQLException {
	...
	public int[] executeBatch(String sql, List<ArrayList<Object>> params) throws SQLException {
		...
		try {
			...
			for (ArrayList<Object> batchParams : params) {
				batchDetail.append("批次[")
					.append(batchIndex++)
					.append("]: ")
					.append(SQLFormatter.format(sql, batchParams))
					.append("\n");
