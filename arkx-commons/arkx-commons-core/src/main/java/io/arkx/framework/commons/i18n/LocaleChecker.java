...
/**
 * A tool which checks locale files for consistency. This tool compares a
 * reference locale file against another local file. It reports if any text
 * translations are missing, or are superflous (unused). This tool can be run
 * from the build file by typing: <code>ant locale</code>.
 * <p>
 * Symbols that are reported <b>MISSING</b> should be added, symbols that are
 * reported <b>UNUSED</b> should be removed or renamed.
 *
...
public class LocaleChecker {
     ...
     * <p>
     * Run: <code>java Locale &lt;reference locale&gt; &lt;check locale&gt;</code>
     *
     * @param args
