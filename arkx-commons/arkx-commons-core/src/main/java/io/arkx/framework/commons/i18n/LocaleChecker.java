...
/**
 * A tool which checks locale files for consistency. This tool compares a reference locale
 * file against another local file. It reports if any text translations are missing, or
 * are superflous (unused). This tool can be run from the build file by typing:
 * <code>ant locale</code>.
 * <p>
...
public class LocaleChecker {
	 ...
	 * @param args first argument is the reference locale file, the second argument is the
	 * locale to check
	 */
