...
/**
 * @class org.ark.framework.orm.query.Restrictions 约束
 *
 * 方法 说明 Restrictions.eq 等于 Restrictions.allEq 使用Map，使用key/value进行多个等于的比对 Restrictions.gt
 * 大于 > Restrictions.ge 大于等于 >= Restrictions.lt 小于 < Restrictions.le 小于等于 <=
 * Restrictions.between 对应SQL的BETWEEN子句 Restrictions.like 对应SQL的LIKE子句 Restrictions.in
 * 对应SQL的in子句 Restrictions.and and关係 Restrictions.or or关係
 * @author Darkness
...
public class Restrictions {
	...
	// public static Restrictions between(String filed, Date startValue, Date
	// endValue) {
