...
public class ClassUtil {
	 ...
	 */
	@Deprecated
	public static String[] OldgetMethodParamNames(Class<?> clazz, String method)
			throws NotFoundException, MissingLVException {
	 ...
	 * @return the first generic declaration, or <code>Object.class</code> if cannot be
	 * determined
	 * @since JDP 2.1.0
	 */
	 ...
	 * @return the index generic declaration, or <code>Object.class</code> if cannot be
	 * determined
	 * @since JDP 2.1.0
	 */
