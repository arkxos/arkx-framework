...
// */
// private static ThreadLocal<BlockingTransaction> current = new
// ThreadLocal<>();
//
// /**
...
// 注意如果没有dataAccess.conn的检测，则会死循环
// return null;
// }
...
// * 增加一个DAO操作,并立即将操作发送到数据库
// */
// public void addWithException(DAO<?> repository, int type) throws Exception
// {// NO_UCD
...
// * 增加一个DAOSet操作,并立即将操作发送到数据库
// */
// public void addWithException(DAOSet<?> set, int type) throws Exception {//
// NO_UCD
...
// throw new DatabaseException("Can't setDataAccess() from
// BlockingTransaction!");
// }
//
// }
