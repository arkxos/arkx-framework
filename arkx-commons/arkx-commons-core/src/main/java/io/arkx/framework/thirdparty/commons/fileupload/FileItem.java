...
public interface FileItem extends Serializable {
     ...
     * name, without path information. However, some clients, such as the Opera
     * browser, do include path information.
     *
     ...
     * same item. This allows a particular implementation to use, for example, file
