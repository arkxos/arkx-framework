...
public class RandomValue {
     ...
     *
     * @param min
     *            指示参数 current 出现的概率。概率计算公式为 min / (min + max)。 该参数的默认值为 1，即有 50%
     *            的概率返回参数 current。
     * @param max
     *            指示参数 current 的相反值 !current 出现的概率。概率计算公式为 max / (min + max)。
     ...
     *
     * @param pool
     *            表示字符池，将从中选择一个字符返回 lower: "abcdefghijklmnopqrstuvwxyz", upper:
     *            "ABCDEFGHIJKLMNOPQRSTUVWXYZ", number: "0123456789", symbol:
     *            "!@#$%^&*()[]" 也可自定义
     * @author "lixingwu"
     */
     ...
     *
     * @param size
     *            指示图片的宽高，格式为 '宽x高'。例如：“300x250”，”360x123“
     * @author "lixingwu"
     */
     ...
     * 'prospero'、'telnet'、'rlogin'、'tn3270'、'wais'。 创建时间：2019-06-14 22:10:52
     * 创建作者：李兴武
     *
     * @author "lixingwu"
     */
    ...
    public static void main(String[] args) throws ScriptException {
        ...
        Console.log(id());
        Console.log(
                mock("{'number1|1-100.1-10': 1,'number2|123.1-10': 1 ,'number3|123.3': 1, 'number4|123.10': 1.123 }"));
