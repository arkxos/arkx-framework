...
public class RandomValue {
	...
	private static String[] register = "110000,120000,130000,210000,220000,230000,232700,210401,310000,320706,320000,350102,320601,320283,220281,220281,530100,530300,53040,530500,530600"
		.split(",");
	...
	/**
	 * 方法描述：调用mockJs生成模拟数据. 创建时间：2019-06-14 14:59:00 创建作者：李兴武
	 * @param script js脚本
	...
	public static Object mockRandom(String script) throws ScriptException {
		// 把mockjs读取到缓存
		if (lfuCache.isEmpty()) {
			String scriptString = FileUtil.readString(RandomValue.class.getResource("/static/mock-min.js"), "utf-8");
	...
	/**
	 * 方法描述：返回一个随机的布尔值. 创建时间：2019-06-14 15:08:42 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：返回一个随机的布尔值. 创建时间：2019-06-14 15:08:42 创建作者：李兴武
	 * @param min 指示参数 current 出现的概率。概率计算公式为 min / (min + max)。 该参数的默认值为 1，即有 50% 的概率返回参数
	 * current。
	 * @param max 指示参数 current 的相反值 !current 出现的概率。概率计算公式为 max / (min + max)。 该参数的默认值为
	 * 1，即有 50% 的概率返回参数 !current。
	 * @param current 可选值为布尔值 true 或 false。如果未传入任何参数，则返回 true 和 false 的概率各为 50%。
	 * 该参数没有默认值。在该方法的内部，依据原生方法 Math.random() 返回的（浮点）数来计算和返回布尔值， 例如在最简单的情况下，返回值是表达式
	 * Math.random() >= 0.5 的执行结果。
	 * @return the boolean
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：返回一个随机的自然数（大于等于 0 的整数）。 创建时间：2019-06-14 15:40:20 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：返回一个随机的浮点数。. 创建时间：2019-06-14 15:53:04 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	 ...
	 * 创建时间：2019-06-14 15:59:16 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：返回一个随机字符。 创建时间：2019-06-14 15:59:16 创建作者：李兴武
	 * @param pool 表示字符池，将从中选择一个字符返回 lower: "abcdefghijklmnopqrstuvwxyz", upper:
	 * "ABCDEFGHIJKLMNOPQRSTUVWXYZ", number: "0123456789", symbol: "!@#$%^&*()[]" 也可自定义
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：返回一个随机字符串. 创建时间：2019-06-14 16:07:50 创建作者：李兴武
	...
	/**
	 * 方法描述：返回一个整型数组。 创建时间：2019-06-14 17:34:27 创建作者：李兴武
	...
	/**
	 * 方法描述：返回一个随机的日期字符串. 创建时间：2019-06-14 20:33:11 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：返回一个随机的时间字符串。 创建时间：2019-06-14 20:38:31 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：返回一个随机的日期和时间字符串。 创建时间：2019-06-14 20:38:31 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：生成一个随机的图片地址。 创建时间：2019-06-14 21:10:09 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	public static String image() throws ScriptException {
		...
		Object random = mockRandom(format);
		return HttpUtil.encodeParams(Convert.toStr(random), CharsetUtil.CHARSET_UTF_8);
	}
	...
	public static String image(String size, String background, String foreground, String imgFormat, String text)
		...
		String format = StrFormatter.format("Random.image('{}','{}','{}','{}','{}')", size, background, foreground,
				imgFormat, text);
		Object random = mockRandom(format);
		return HttpUtil.encodeParams(Convert.toStr(random), CharsetUtil.CHARSET_UTF_8);
	}
	...
	/**
	 * 方法描述：随机生成一个有吸引力的颜色，格式为 '#RRGGBB'。 创建时间：2019-06-14 21:39:33 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个有吸引力的颜色，格式为 'rgb(r, g, b)'。 创建时间：2019-06-14 21:39:33 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个有吸引力的颜色，格式为 'rgba(r, g, b, a)'。 创建时间：2019-06-14 21:39:33 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个有吸引力的颜色，格式为 'hsl(h, s, l)'。 创建时间：2019-06-14 21:39:33 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一段英文文本。 创建时间：2019-06-14 21:47:07 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一段中文文本。 创建时间：2019-06-14 21:47:07 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个单词。 创建时间：2019-06-14 21:47:07 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个汉字。 创建时间：2019-06-14 21:47:07 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成 length 个汉字。 创建时间：2019-06-14 21:47:07 创建作者：李兴武
	...
	/**
	 * 方法描述：随机生成汉字。 创建时间：2019-06-14 21:47:07 创建作者：李兴武
	...
	/**
	 * 方法描述：随机生成一句标题，其中每个单词的首字母大写。 创建时间：2019-06-14 22:04:58 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一句中文标题。 创建时间：2019-06-14 22:04:58 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个常见的英文名。 创建时间：2019-06-14 22:10:52 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个常见的英文姓。 创建时间：2019-06-14 22:10:52 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个常见的英文姓名。 创建时间：2019-06-14 22:10:52 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个常见的中文名。 创建时间：2019-06-14 22:10:52 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个常见的中文姓。 创建时间：2019-06-14 22:10:52 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个常见的中文姓名。 创建时间：2019-06-14 22:10:52 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个 URL。 创建时间：2019-06-14 22:10:52 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	 ...
	 * 'prospero'、'telnet'、'rlogin'、'tn3270'、'wais'。 创建时间：2019-06-14 22:10:52 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个域名。 创建时间：2019-06-14 22:10:52 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个顶级域名（Top Level Domain）。 创建时间：2019-06-14 22:10:52 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个邮件地址。 创建时间：2019-06-14 22:10:52 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个 IP 地址。 创建时间：2019-06-14 22:10:52 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个（中国）大区。 创建时间：2019-06-14 22:24:57 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个（中国）省（或直辖市、自治区、特别行政区）。 创建时间：2019-06-14 22:24:57 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个（中国）市。 创建时间：2019-06-14 22:24:57 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个（中国）县。 创建时间：2019-06-14 22:24:57 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个邮政编码（六位数字）。 创建时间：2019-06-14 22:24:57 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：随机生成一个 18 位身份证。 创建时间：2019-06-14 22:36:17 创建作者：李兴武
	 *
	 * @author "lixingwu"
	 */
	...
	/**
	 * 方法描述：根据数据模板生成模拟数据。 创建时间：2019-06-14 22:42:12 创建作者：李兴武
	...
	public static void main(String[] args) throws ScriptException {
		...
		Console.log(id());
		Console
			.log(mock("{'number1|1-100.1-10': 1,'number2|123.1-10': 1 ,'number3|123.3': 1, 'number4|123.10': 1.123 }"));
