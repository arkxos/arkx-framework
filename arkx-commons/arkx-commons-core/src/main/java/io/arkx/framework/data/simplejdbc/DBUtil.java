...
public class DBUtil {
	...
	public static <T> List<T> executeQuery(String sql, Object[] parameters, int columnCount,
			IQueryBuildEntity<T> queryBuildEntity) {
		PreparedStatement statement = null;
		ResultSet resultSet = null;
	...
	private static <T> List<T> buildResult(ResultSet resultSet, int columnCount, IQueryBuildEntity<T> queryBuildEntity)
			throws SQLException {
