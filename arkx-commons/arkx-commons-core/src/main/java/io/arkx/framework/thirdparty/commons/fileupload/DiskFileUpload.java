 ...
 * depending on their size, and will be available as {@link FileItem}s.
 * </p>
 *
...
public class DiskFileUpload extends FileUploadBase {
    ...
    /**
     * Sets the factory class to use when creating file items. The factory must be
     * an instance of <code>DefaultFileItemFactory</code> or a subclass thereof, or
     * else a <code>ClassCastException</code> will be thrown.
     *
     * @param factory
     ...
     * @return A list of <code>FileItem</code> instances parsed from the request, in
