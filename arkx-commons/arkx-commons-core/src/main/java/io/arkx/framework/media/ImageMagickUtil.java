...
public class ImageMagickUtil {
            ...
            if (subIndex == 4) {
                ...
                if ("fill".equals(sMode)) {
                    if (subIndex < mode.length() - 1) {
                        ...
                        op.thumbnail(Integer.valueOf(toWidth), Integer.valueOf(toHeight), Character.valueOf('^'))
                                .gravity(getPositionString(cutLoc))
                                .extent(Integer.valueOf(toWidth), Integer.valueOf(toHeight));
                    } else {
                        op.thumbnail(Integer.valueOf(toWidth), Integer.valueOf(toHeight), Character.valueOf('^'))
                                .gravity(getPositionString(5))
                                .extent(Integer.valueOf(toWidth), Integer.valueOf(toHeight));
                    }
                } else {
                    op.resize(Integer.valueOf(toWidth), Integer.valueOf(toHeight));
                ...
                if ("fill".equals(mode)) {
                    op.thumbnail(Integer.valueOf(toWidth), Integer.valueOf(toHeight), Character.valueOf('^'))
                            .gravity(getPositionString(5)).extent(Integer.valueOf(toWidth), Integer.valueOf(toHeight));
                } else {
                    op.resize(Integer.valueOf(toWidth), Integer.valueOf(toHeight));
                }
            } else {
    ...
    public static final void pressImage(String targetImg, String pressImg, int position, int opicty) throws Exception {
