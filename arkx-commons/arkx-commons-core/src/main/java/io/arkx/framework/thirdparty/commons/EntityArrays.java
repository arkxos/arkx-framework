...
/**
 * Class holding various entity data for HTML and XML - generally for use with the
 * LookupTranslator. All arrays are of length [*][2].
 *
 * @since 3.0
...
public class EntityArrays {
	 ...
	 * references</a>. Note that this must be used with {@link #ISO8859_1_ESCAPE()} to get
	 * the full list of HTML 4.0 character entities.
	 * @return the mapping table
	 */
	...
	private static final String[][] HTML40_EXTENDED_ESCAPE = {
			// <!-- Latin Extended-B -->
			{ "\u0192", "&fnof;" }, // latin small f with hook = function= florin, U+0192
									// ISOtech -->
			// <!-- Greek -->
			...
			{ "\u2118", "&weierp;" }, // script capital P = power set= Weierstrass p,
										// U+2118 ISOamso -->
			{ "\u2111", "&image;" }, // blackletter capital I = imaginary part,U+2111
										// ISOamso -->
			{ "\u211C", "&real;" }, // blackletter capital R = real part symbol,U+211C
									// ISOamso -->
			{ "\u2122", "&trade;" }, // trade mark sign, U+2122 ISOnum -->
			{ "\u2135", "&alefsym;" }, // alef symbol = first transfinite cardinal,U+2135
										// NEW -->
			...
			// -->
			{ "\u0160", "&Scaron;" }, // -- latin capital letter S with caron,U+0160
										// ISOlat2 -->
			{ "\u0161", "&scaron;" }, // -- latin small letter s with caron,U+0161 ISOlat2
										// -->
			{ "\u0178", "&Yuml;" }, // -- latin capital letter Y with diaeresis,U+0178
									// ISOlat2 -->
