...
public class SimpleQuery extends Query {
        ...
        for (int i = 0; i < orderby.length(); i++) {
            ...
            if (c == ' ') {
                ...
                if (nameFlag) {
                    ...
                    // else {
                    // throw new QueryException("Maybe a SQL Injection: orderby=" +
                    // orderby);
                    // }
                }
     ...
     *
     * @param field
     *            group by 后面跟承受的字段名，字段名后面可以有“ desc”和“ asc”
     */
