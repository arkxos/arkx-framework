...
public class ZDrawTextItem extends DrawTextItem {
    ...
    public ZDrawTextItem(String text, Color fontColor, Color fontShadowColor, Font font, float opicty, float x,
            float y) {
    ...
    public ZDrawTextItem(String text, Color fontColor, Color outlineColor, int outlineSize, Font font, float opicty,
            float x, float y, boolean underline) {
        super(text, fontColor, null, font, 0);
    ...
    public ZDrawTextItem(String text, Color fontColor, Color fontShadowColor, Color outlineColor, int outlineSize,
            Font font, float x, float y, boolean underline) {
        super(text, fontColor, fontShadowColor, font, 0);
        this.outlineColor = outlineColor;
        this.outlineSize = outlineSize;
        this.x = x;
    ...
    public void drawText(Graphics2D graphics, int width, int height) {
        ...
        if (this.outlineColor != null) {
            ...
            graphics.drawString(this.text, this.x + getShadowTranslation(this.defaultFont.getSize()),
                    this.y + getShadowTranslation(this.defaultFont.getSize()));
        }
        graphics.setColor(this.fontColor);
