...
/**
 * @class org.ark.framework.extend.plugin.ExtendServiceConfig 扩展服务配置
 * @private
 * @author Darkness
...
public class ExtendServiceConfig {
	 ...
	 * @param extendServiceNodeData 传过来的extendService节点格式如下： <extendService>
	 ...
	 * <itemClass>org.ark.framework.cache.CacheProvider</itemClass> </extendService>
	 *
	 * @author Darkness
			...
			if (instance == null) {
				...
				try {
					if (instance == null) {
						...
						try {
							List<ExtendItemConfig> list = ExtendPluginProvider.getInstance()
								.findItemsByServiceID(this.id);
