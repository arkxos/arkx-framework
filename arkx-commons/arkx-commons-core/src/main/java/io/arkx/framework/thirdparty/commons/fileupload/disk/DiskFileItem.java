 ...
 * <p>
 * After retrieving an instance of this class from a {@link DiskFileUpload
 * DiskFileUpload} instance (see {@link DiskFileUpload
 * #parseRequest(javax.servlet.http.HttpServletRequest)} ), you may either
...
public class DiskFileItem implements FileItem {
     ...
     * provided by the sender. Media subtypes of the "text" type are defined to have
     ...
     *            specified.
     * @param isFormField
     *            Whether or not this item is a plain form field, as opposed to a
     *            file upload.
     * @param fileName
    ...
    /**
     * Returns the contents of the file as an array of bytes. If the contents of the
     ...
     * not concerned with whether or not the item is stored in memory, or on disk in
     * a temporary location. They just want to write the uploaded item to a file.
     * <p>
    ...
    public void write(File file) throws Exception {
        if (isInMemory()) {
            ...
            if (outputFile != null) {
                ...
                /*
                 * The uploaded file is being stored on disk in a temporary location so move it
                 * to the desired file.
                 */
    ...
    /**
     * Specifies whether or not a <code>FileItem</code> instance represents a simple
     * form field.
     *
     * @param state
     ...
     * {@link java.io.File#renameTo(java.io.File)} to move the file to new location
     * without copying the data, if the source and destination locations reside
     * within the same logical volume.
     *
     ...
     * tied to the lifetime of the <code>FileItem</code> instance; the file will be
