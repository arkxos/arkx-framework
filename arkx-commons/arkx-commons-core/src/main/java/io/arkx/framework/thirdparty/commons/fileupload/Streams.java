...
public final class Streams {
	 ...
	 * </pre>
	 * @param inputStream The input stream, which is being read. It is guaranteed, that
	 * {@link InputStream#close()} is called on the stream.
	 * @param outputStream The output stream, to which data should be written. May be
	 * null, in which case the input streams contents are simply discarded.
	 * @param closeOutputStream True guarantees, that {@link OutputStream#close()} is
	 * called on the stream. False indicates, that only {@link OutputStream#flush()}
	 ...
	 * called on the stream. False indicates, that only {@link OutputStream#flush()}
	 * should be called finally.
	 * @param buffer Temporary buffer, which is to be used for copying data.
	 * @return Number of bytes, which have been copied.
	 * @throws IOException An I/O error occurred.
	 */
	public static long copy(InputStream inputStream, OutputStream outputStream, boolean closeOutputStream,
	 ...
	 * {@link org.apache.commons.fileupload2.FileItemStream}'s content into a string. The
	 * platform's default character encoding is used for converting bytes into characters.
	...
	/**
	 * This convenience method allows to read a
	 * {@link org.apache.commons.fileupload2.FileItemStream}'s content into a string,
	...
	/**
	 * Checks, whether the given file name is valid in the sense, that it doesn't contain
	 * any NUL characters. If the file name is valid, it will be returned without any
	 * modifications. Otherwise, an {@link InvalidFileNameException} is raised.
