...
/**
 * * 移植自Spring：<br>
 * Implementation of the {@link NativeJdbcExtractor} interface for WebLogic, supporting
 * WebLogic Server 8.1 and higher.
 * <p>
 * Returns the underlying native Connection to application code instead of WebLogic's
 ...
 * <p>
 * This NativeJdbcExtractor can be set just to <i>allow</i> working with a WebLogic
 * DataSource: If a given object is not a WebLogic Connection wrapper, it will be returned
 * as-is.
 *
...
public class WebLogicNativeJdbcExtractor {
	...
	/**
	 * This constructor retrieves the WebLogic JDBC extension interface, so we can get the
