...
public class ImageUtil {
    ...
    public static Paint getColor(Object color, Color defaultColor) {
        ...
        if (colorStr.startsWith("#"))
            ...
            c = new Color(Integer.parseInt(rgb[0].trim()), Integer.parseInt(rgb[1].trim()),
    ...
    public static void pressText(String filePath, String pressText, Font font, Color color, float opicty, int position)
            throws Exception {
    ...
    public static void pressText(String filePath, String pressText, Font font, Color color, Color outlineColor,
            int outlineSize, float opicty, int position) throws Exception {
        int xy[] = getPosition(filePath, pressText, font.getSize(), position);
        if (existsGraphicsMagick())
            ImageMagickUtil.pressText(filePath, pressText, font, color, outlineColor, outlineSize, false, opicty, xy[0],
                    xy[1]);
        else
            SimpleImageUtil.pressText(filePath, pressText, font, color, outlineColor, outlineSize, false, opicty, xy[0],
                    xy[1]);
    }

    public static void pressText(String filePath, String pressText, Font font, Color color, Color shadowColor,
            float opicty, int position) throws Exception {
        int xy[] = getPosition(filePath, pressText, font.getSize(), position);
        if (existsGraphicsMagick())
    ...
    public static void pressText(String filePath, String pressText, Font font, Color color, Color outlineColor,
        ...
        if (existsGraphicsMagick())
            SimpleImageUtil.pressText(filePath, pressText, font, color, outlineColor, outlineSize, underline, opicty, x,
                    y);
        else
            SimpleImageUtil.pressText(filePath, pressText, font, color, outlineColor, outlineSize, underline, opicty, x,
                    y);
    ...
    public static final void txtToImage(String dest, String txt, Font font, Color fontColor, Color bgColor)
            throws Exception {
        if (existsGraphicsMagick())
