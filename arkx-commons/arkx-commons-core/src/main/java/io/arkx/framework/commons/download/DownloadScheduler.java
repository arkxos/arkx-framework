...
//
//// private ConcurrentHashMap<Future<?>, RemoteHttpPartFile> workerFuturesMap =
// new ConcurrentHashMap<>();
//// private ConcurrentHashMap<Integer, ConcurrentLinkedQueue<Future<?>>>
// missionWorkerFutures = new ConcurrentHashMap<>();
//
...
//// if (t == null) {
//// System.out.println(Thread.currentThread().getId() + " has been succeesfully
// finished!");
//// } else {
...
//// ConcurrentLinkedQueue<Future<?>> futures =
// missionWorkerFutures.get(missionId);
...
//// ConcurrentLinkedQueue<Future<?>> futures =
// missionWorkerFutures.remove(missionId);
