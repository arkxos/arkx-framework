...
public class UpdatePrivilegeType {
	...
	// m.put("io.arkx.framework.cms.ImagePlayer.Delete",
	// "ImagePlayerManage.Delete");
	// m.put("io.arkx.framework.cms.ImagePlayer.CommitAudit",
	// "ImagePlayerManage.CommitAudit");
	// m.put("io.arkx.framework.cms.ImagePlayer.Audit", "ImagePlayerManage.Audit");
	// m.put("io.arkx.framework.cms.ImagePlayer.Publish",
	// "ImagePlayerManage.Publish");
	//
