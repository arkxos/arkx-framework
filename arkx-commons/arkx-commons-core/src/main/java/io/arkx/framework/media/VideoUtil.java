...
public class VideoUtil {
	...
	public static boolean captureImage(String src, String dest) {
		...
		if (duration < 30L) {
			return captureImage(src, dest, Long.valueOf(duration / 3L).intValue(), parser.getWidth(),
					parser.getHeight());
		}
	...
	public static boolean convertAndWatermark2Flv(String src, String dest, String videoResolution, String imagePath,
			FfmpegCommandBuilder.VideoWatermarkPosition position, AfterVideoConvertEvent event) {
		...
		if ((dest == null) || (dest.equals(src))) {
			dest = src.substring(0, src.lastIndexOf("/") + 1) + "_watermarkt_"
	...
	public static boolean convertAndWatermark2Mp4(String src, String dest, String videoResolution, String imagePath,
			FfmpegCommandBuilder.VideoWatermarkPosition position, AfterVideoConvertEvent event) {
	...
	public static void waterMark(String src, String dest, String imagePath,
			FfmpegCommandBuilder.VideoWatermarkPosition position, AfterVideoConvertEvent event) {
	...
	private static void execute(List<String> commandList, String src, String dest, boolean rewriteSourceFile,
			AfterVideoConvertEvent event) {
		execute(null, commandList, src, dest, rewriteSourceFile, event);
	}

	public static void execute(String directory, List<String> commandList, final String src, final String dest,
			final boolean rewriteSourceFile, final AfterVideoConvertEvent event) {
	...
	public static String readInputStream(InputStream is, String f) throws IOException {
