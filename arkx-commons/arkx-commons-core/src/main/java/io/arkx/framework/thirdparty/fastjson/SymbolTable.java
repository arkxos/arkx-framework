...
public class SymbolTable {
    ...
    /**
     * Adds the specified symbol to the symbol table and returns a reference to the
     * unique symbol. If the symbol already exists, the previous symbol reference is
     * returned instead, in order guarantee that symbol references remain unique.
     *
     * @param buffer
