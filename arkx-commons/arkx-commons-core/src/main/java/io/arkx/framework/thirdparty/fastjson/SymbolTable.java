...
public class SymbolTable {
	...
	/**
	 * Adds the specified symbol to the symbol table and returns a reference to the unique
	 * symbol. If the symbol already exists, the previous symbol reference is returned
	 * instead, in order guarantee that symbol references remain unique.
	...
	protected static final class Entry {
		...
		/**
		 * Constructs a new entry from the specified symbol information and next entry
		 * reference.
		 */
