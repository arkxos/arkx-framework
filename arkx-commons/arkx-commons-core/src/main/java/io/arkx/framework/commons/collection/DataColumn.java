...
/**
 * @class org.ark.framework.collection.DataColumn 数据字段，表示DataTable中的一个列
 * @author Darkness
...
public class DataColumn implements Serializable, Cloneable, JSONAware {
    ...
    // private DataColumn(String columnName, DataTypes columnType, boolean
    // allowNull) {
    ...
    public String toString() {
        return "ColumnName:" + getColumnName() + ",ColumnType:" + getColumnType() + ",isAllowNull:" + isAllowNull()
