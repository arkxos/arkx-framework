 ...
 * such as the Australian Dollar or the British Pound, rather than an acutal
 * amount of money. We use our own representation because the Java API's
 * Currency class has no way of returning a NumberFormat object. So we could not
...
public class Currency implements Cloneable, Comparable<Currency> {
        ...
        if (currencyList == null) {
            ...
            for (int i = 0; i < locales.length; i++) {
                try {
                    ...
                    // Skip locales without a currency. E.g. "en_" (English) has no
                    // currency,
    ...
    /**
     * Return the currency associated with the default locale. If there is no
     * currency associated with the default locale, it will use the US Dollar.
     *
    ...
    /**
     * Create an instance of the currency associated with the given locale. If the
     * given locale has no associated currency, e.g. Antartica, this function will
     * default to the US dollar.
     *
     * @param locale
     *            use the currency associated with this locale
     */
    ...
    /**
     * Create an an instance of the currency using the currency described by the
     * given ISO 4217 currency code.
     *
     * @param currencyCode
     *            the ISO 4217 currency code (3 characters).
     * @exception UnknownCurrencyCodeException
     *                if the currency code is not known.
     */
    ...
    /**
     * Return the number of fraction digits used to display this currency. For
     * examle, the Australian Dollar has 2 fraction digits (e.g. $12.95) while the
     * Japanese Yen has zero (e.g. 100 yen).
     *
    ...
    /**
     * Return the number format which can be used to form a number into the
     * appropriate locale representation of this currency.
     *
     ...
     * currency, it will throw a <code>ClassCastException</code>. Currencies are
     * ordered alphabetically by their ISO 4217 currency codes.
     *
     * @param object
     *            currency object to be compared
     ...
     *                if the argument is not a <code>Currency</code>.
     */
    @Override
     ...
     * @param object
     *            currency object to be compared
     * @return <code>true</code> if the currencies are the same; <code>false</code>
     *         otherwise.
     * @exception ClassCastException
     *                if the argument is not a <code>Currency</code>.
     */
    ...
    /**
     * Create and return a compare of this currency. Since currencies are immutable,
     * this simply returns this object.
     *
     * @return this object.
     */
    @Override
