...
public class JSONScanner implements JSONLexer {
    ...
    /**
     * Return the current token's position: a 0-based offset from beginning of the
     * raw input stream (before unicode translation)
     */
    @Override
    ...
    /**
     * The value of a literal token, recorded as a string. For integers, leading 0x
     * and 'l' suffixes are suppressed.
     */
    @Override
