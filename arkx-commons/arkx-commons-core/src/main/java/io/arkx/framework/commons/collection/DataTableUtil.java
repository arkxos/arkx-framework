...
public class DataTableUtil {
    ...
    // public static DataTable extendBackupData(DataTable dt, String sql, String
    // key) {
    // for (int i = 0; i < dt.getRowCount(); i++) {
    // DataRow dr = dt.getDataRow(i);
    // String keyValue = dr.getString(key);
    // DataTable backdt = new QueryBuilder(sql, new Object[] { keyValue
    // }).executePagedDataTable(1, 0);
    // if (i == 0) {
    // for (int j = 0; j < backdt.getColumnCount(); j++) {
    // backdt.getDataColumn(j).setColumnName("Backup" +
    // backdt.getDataColumn(j).getColumnName());
    // dt.insertColumn(backdt.getDataColumn(j).getColumnName());
    // }
    // }
    // if (backdt.getRowCount() == 1) {
    // System.arraycopy(backdt.getDataRow(0).getDataValues(), 0,
    // dt.getDataRow(i).getDataValues(), dt.getColumnCount() -
    // backdt.getColumnCount(), backdt.getColumnCount());
    // }
    // }
    // return null;
    // }
