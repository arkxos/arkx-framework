...
public class FileUtil {
     ...
     * @throws IOException
     */
    public static long copy(String filePath, OutputStream outputStream, boolean close, byte[] buffer)
            throws IOException {
     ...
     * @throws IOException
     */
    public static long copy(InputStream inputStream, OutputStream outputStream, boolean close, byte[] buffer)
            throws IOException {
    ...
    private static boolean renameToSubDir(String oldPath, String newPath, boolean deleteOldDir) {
        ...
        if (oldParent == null) {
            ...
            // LogUtil.info("Cannot " + action + " directory:" + oldPath + " to a
            // subdirectory of itself " + newPath);
            return false;
        }
        // 生成临时文件夹
