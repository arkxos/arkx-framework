...
//                "http://quotes.money.163.com/trade/lsjysj_002693.html");
	...
	public void init() {
		try {
	        ...
	        if(this.size == -1) {
//	        	System.out.println("========unget file size, url["+url+"], retry " + retryCount);
		        if (retryCount++ < maxRetryCount) {
					init();
				} else {
	//				throw new RuntimeException("UnSupported response code:" + responseCode);
...
//	        	System.out.println("========get file size, url["+url+"], retry " + retryCount);
	        }
	...
	public String toString() {
		...
		String result = "fileName: " + this.getFileName() + ", fileSize["+getSize()+"]: " + sizeString + ", isSupportRange:" + this.isAcceptRanges();
		return result;
	}
...
//		String url = "http://quotes.money.163.com/service/chddata.html?code=1002693&start=20120731&end=20171012&fields=TCLOSE;HIGH;LOW;TOPEN;LCLOSE;CHG;PCHG;TURNOVER;VOTURNOVER;VATURNOVER;TCAP;MCAP";
