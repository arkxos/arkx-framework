 ...
 *
 * // 添加子节点 TreeNode<String> child1 = new TreeNode<>("Child1"); TreeNode<String>
 * child2 = new TreeNode<>("Child2"); root.addChild(child1);
 ...
 *
 * 输出： └── Root │ └── Child1 │ │ └── Grandchild1 │ │ └── Grandchild2 │ └──
 * Child2
 *
 *
 * // 前序遍历 System.out.println("前序遍历: " + root.preorderTraversal()); // [Root,
 * Child1, Grandchild1, Grandchild2, Child2]
 *
 * // 后序遍历 System.out.println("后序遍历: " + root.postorderTraversal()); //
