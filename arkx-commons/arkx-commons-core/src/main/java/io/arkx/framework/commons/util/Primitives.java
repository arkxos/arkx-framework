...
public class Primitives {
    ...
    public static final Class<?>[] primitiveClass = new Class<?>[]{int.class, long.class, boolean.class, char.class,
            byte.class, short.class, Integer.class, Long.class, Boolean.class, Character.class, Byte.class,
            Short.class};

    public static final Class<?>[] primitiveArrClass = new Class<?>[]{int[].class, long[].class, boolean[].class,
            char[].class, byte.class, short.class, Integer[].class, Long[].class, Boolean[].class, Character[].class,
