 ...
 * <p>
 * 源代码中解析帧头32位用到的变量及含义：
 * <table border="2" bordercolor="#000000" cellpadding="8" style=
...
public final class Header {
	...
	/*
	 * verID: 2-bit '00' MPEG-2.5 (unofficial extension of MPEG-2); '01' reserved; '10'
	 * MPEG-2 (ISO/IEC 13818-3); '11' MPEG-1 (ISO/IEC 11172-3).
	 */
	private int verID;
	...
	/*
	 * protection_bit: 1-bit '1' no CRC; '0' protected by 16-bit CRC following header.
	 */
	...
	/*
	 * mode: 2-bit '00' Stereo; '01' Joint Stereo (Stereo); '10' Dual channel (Two mono
	 * channels); '11' Single channel (Mono).
	 */
	private int mode;

	/*
	 * mode_extension: 2-bit intensity_stereo MS_stereo '00' off off '01' on off '10' off
	 * on '11' on on
	 */
	 ...
	 * 获取声道模式。
	 * @return 声道模式，其值表示的含义：
	 * <table border="1" bordercolor="#000000" cellpadding="8" style=
	 * "border-collapse:collapse">
	 * <tr>
	 * <th>返回值</th>
	 * <th>声道模式</th>
	 ...
	 * <tr>
	 * <td>1</td>
	 * <td>联合立体声（joint stereo）</td>
	 * </tr>
	 * <tr>
	 * <td>2</td>
	 * <td>双声道（dual channel）</td>
	 * </tr>
	 * <tr>
	 * <td>3</td>
	 * <td>单声道（mono channel）</td>
	 * </tr>
	 * </table>
	 ...
	 * 获取帧长度。
	 * <p>
	 * 帧的长度 = 4字节帧头 + CRC（如果有的话，2字节） + 音乐数据长度。 <br>
	...
	public String toString() {
		...
		sbuf.append(layer);
		sbuf.append(", ");
		sbuf.append(getSamplingRate());
		sbuf.append("Hz, ");

		if (mode == 0)
			sbuf.append("Stereo");
		else if (mode == 1)
			sbuf.append("Joint Stereo");
		else if (mode == 2)
			sbuf.append("Dual channel");
		else if (mode == 3)
			sbuf.append("Mono");
