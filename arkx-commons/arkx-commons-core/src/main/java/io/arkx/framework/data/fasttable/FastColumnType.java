...
public enum FastColumnType {
    ...
    Byte((byte) 1, BufferReader.BYTE_LENGTH), Char((byte) 2, 2), Short((byte) 3, 2),
    Int((byte) 4, BufferReader.INT_LENGTH), Long((byte) 5, BufferReader.LONG_LENGTH),
    Float((byte) 6, BufferReader.FLOAT_LENGTH), Double((byte) 7, BufferReader.DOUBLE_LENGTH),
    Boolean((byte) 8, BufferReader.BYTE_LENGTH),

    FixedString((byte) 9, -1), String((byte) 10, -1),

    Date((byte) 11, BufferReader.LONG_LENGTH), DateTime((byte) 12, BufferReader.LONG_LENGTH);
