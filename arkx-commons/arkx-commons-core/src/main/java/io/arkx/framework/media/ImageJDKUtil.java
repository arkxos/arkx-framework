...
public class ImageJDKUtil {
    ...
    public static void writeImageFile(String fileName, BufferedImage image) throws IOException {
        ...
        // 48: ldc_w 268
        // 51: aload_2
        // 52: invokestatic 270 javax/imageio/ImageIO:write
        ...
        // 79: ifeq +33 -> 112
        // 82: aload_2
        // 83: invokestatic 278 com/sun/image/codec/jpeg/JPEGCodec:createJPEGEncoder
        // (Ljava/io/OutputStream;)Lcom/sun/image/codec/jpeg/JPEGImageEncoder;
        // 86: astore_3
        // 87: aload_3
        // 88: aload_1
    ...
    public static void txtToImage(File dest, String txt, Font font, Color fontColor, Color bgColor) throws Exception {
    ...
    public static void txtToImage(OutputStream out, String txt, Font font, Color fontColor, Color bgColor,
            ImageFormat imageFormat) throws Exception {
        Set<String> availbleformats = getAvailableFormat();
    ...
    public static BufferedImage txtToImage(String text, Font font, Color fontColor, Color bgColor, String align,
            int fontWidth, int fontHeight, int letterSpacing, int imageWidth, int imageHeight,
        ...
        attr.put(TextAttribute.TRANSFORM,
                new TransformAttribute(AffineTransform.getScaleInstance(xScaleModule, yScaleModule)));
        for (int i = 0; i < textLength; i++) {
