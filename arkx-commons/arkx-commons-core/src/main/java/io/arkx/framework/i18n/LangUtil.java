...
public class LangUtil {
	...
	private static String[] LangIDArr = new String[] { "ar-", "be-", "bg-", "ca-", "cs-", "da-", "de-", "el-", "en-",
			"es-", "et-", "fi-", "fr-", "hr-", "hu-", "is-", "it-", "iw-", "ja-", "ko-", "lt-", "lv-", "mk-", "nl-",
			"no-", "pl-", "pt-", "ro-", "ru-", "sh-", "sk-", "sl-", "sq-", "sr-", "sv-", "th-", "tr-", "uk-" };
