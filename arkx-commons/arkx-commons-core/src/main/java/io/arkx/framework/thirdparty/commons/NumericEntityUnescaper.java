...
public class NumericEntityUnescaper extends CharSequenceTranslator {
    ...
    /**
     * Create a UnicodeUnescaper. The constructor takes a list of options, only one
     * type of which is currently available (whether to allow, error or ignore the
     * semi-colon on the end of a numeric entity to being missing). For example, to
     * support numeric entities without a ';': new
     ...
     * NumericEntityUnescaper(NumericEntityUnescaper.OPTION.errorIfNoSemiColon) Note
     * that the default behaviour is to ignore them.
     *
     * @param options
