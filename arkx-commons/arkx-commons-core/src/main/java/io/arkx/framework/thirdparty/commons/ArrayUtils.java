...
public class ArrayUtils {// NO_UCD
     ...
     *            or an Array containing at least two elements, may be {@code null}
     ...
     *            If {@code array} is {@code null}, create a size 1 array of this
     *            type.
     ...
     *            source
     * @param indices
     *            to remove, WILL BE SORTED--so only clones of user-owned arrays!
    ...
    public static class MutableInt extends Number implements Comparable<MutableInt> {// NO_UCD
         ...
         * <code>MutableInt</code> object that contains the same <code>int</code> value
         * as this object.
         *
         * @param obj
