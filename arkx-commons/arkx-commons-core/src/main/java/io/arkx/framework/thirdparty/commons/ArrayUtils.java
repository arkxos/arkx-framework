...
public class ArrayUtils {
	 ...
	 * the class should be used as <code>ArrayUtils.clone(new int[] {2})</code>.
	 * </p>
	 * <p>
	 ...
	 * select the type explicitly like in
	 ...
	 * <p>
	 * This method returns a new array with the same elements of the input array except
	 * for the earliest-encountered occurrences of the specified elements. The component
	...
	public static class MutableInt extends Number implements Comparable<MutableInt> {
		 ...
		 * <code>MutableInt</code> object that contains the same <code>int</code> value as
		 * this object.
