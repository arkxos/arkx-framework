 ...
 * @version V1.0
 */
@SupportedAnnotationTypes("io.arkx.infinity.persistence.fastdb.Serialize")
...
public class MyProcessor extends AbstractProcessor {
    ...
    // set = new HashSet<>();
    // }
    // set.add(Serialize.class.getCanonicalName());
    // return set;
    // }

    public static void main(String[] args) {
        System.out.println(Serialize.class.getCanonicalName());
        System.out.println(Serialize.class.getName());
    }
}
