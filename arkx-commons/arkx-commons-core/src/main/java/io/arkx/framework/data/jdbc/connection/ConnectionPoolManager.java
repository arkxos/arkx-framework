...
//
// import io.arkx.framework.framework.Config;
...
// }
//
// public static Connection getConnection(String poolName, boolean
// bLongTimeFlag) {
// return getConnection(poolName, bLongTimeFlag, true);
// }
//
// public static Connection getConnection(String poolName, boolean
// bLongTimeFlag, boolean bCurrentThreadConnectionFlag) {
//
// if (timer == null) {
// synchronized (mutex) {
// initTimer();
...
// Connection conn =
// CurrentConnection.getCurrentThreadConnection();//BlockingTransaction.getCurrentThreadConnection();
