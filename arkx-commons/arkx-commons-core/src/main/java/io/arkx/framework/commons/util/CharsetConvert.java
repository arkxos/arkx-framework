...
/**
 * @class org.ark.framework.utility.CharsetConvert 字符集转换工具类, gbk与utf8编码互转类
 * @author Darkness
 * @date 2012-8-4 上午10:32:58
 * @version V1.0
 */
public class CharsetConvert {
    ...
    public static byte[] convertFile(byte[] bs, String name, String charset) {
        ...
        if (ObjectUtil.in(ext, "exe", "db", "dat", "zdt", "jpg", "jpeg", "gif", "bmp", "zip", "rar", "png", "swf",
                "flv", "rar", "doc", "docx", "xls", "xlsx", "ppt", "psd", "pptx", "pdf", "tif", "dat", "mp3", "ra",
                "asx", "avi", "wmv", "mp4", "mov", "asf", "mpg", "rm", "rmvb")) {
            return bs;
        }
    ...
    /**
     * 将web页面及引用的charset=GBK的替换成charset=utf-8
     *
     * @author Darkness
     * @date 2012-8-4 下午11:18:19
     * @version V1.0
     */
    ...
    /**
     * 将web文件中的charset=utf-8的替换成charset=GBK
     *
     * @author Darkness
     * @date 2012-8-4 下午11:19:39
     * @version V1.0
     */
    ...
    public static void main(String[] args) {
        dirGBKToUTF8("E:\\workspace\\projects\\refactor-demo\\trunk\\source");
    }
