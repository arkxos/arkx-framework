...
public class Config {
    ...
    public static void withTestMode() {
        configPaths = new String[]{Config.getPluginPath() + "classes/", Config.getPluginPath() + "test-classes/"};
    }
        ...
        if (!configMap.containsKey("System.JavaVersion")) {
            ...
            for (XMLElement data : datas) {
                ...
                for (int k = 0; k < children.size(); k++) {
                    ...
                    // value =
                    // UCMConfig.getValue(value.substring(UCMConfig.CONFIGKEY.length()+1));
                    // }
