...
/**
 * @class org.ark.framework.collection.Treex 树形数据结构
 *
 * @author Darkness
...
public class Treex<K, T> implements Iterable<TreeNode<K, T>>, Serializable {
     ...
     */
    public static Treex<String, DataRow> dataTableToTree(DataTable dt, String identifierColumnName,
    ...
    private static void dealNode(TreeNode<String, DataRow> tn, HashMap<String, DataRow> rowMap,
            HashMap<String, ArrayList<String>> parentMap, int idIndex) {
