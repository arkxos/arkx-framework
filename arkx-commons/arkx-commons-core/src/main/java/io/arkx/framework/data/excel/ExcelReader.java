...
public abstract class ExcelReader {
	 ...
	 * @return String
	 */
	// public abstract String readStringExcelCell(int sheetNum, int rowNum, int
	// cellNum);
	// @Override
	...
	public List<String[]> readExcelDataList(int limitRowCount) {
		...
		for (int i = 0; i < sheetCount; i++) {
			sheetNum = i;
			int rowCount = limitRowCount > 0 && limitRowCount < (getRowCount(sheetNum) + 1) ? limitRowCount
					: (getRowCount(sheetNum) + 1);
