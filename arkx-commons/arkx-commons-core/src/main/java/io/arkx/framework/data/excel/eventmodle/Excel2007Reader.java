    ...
    public void endElement(String uri, String localName, String name) throws SAXException {
        ...
        if (nextIsString) {
            try {
                ...
                lastContents = new XSSFRichTextString(sst.getItemAt(idx) + "").toString();
            } catch (Exception e) {
        ...
        if (name.equals("v")) {
            ...
            if (name.equals("row")) {
                /**
                 * int tmpCols = rowlist.size(); if(curRow>this.titleRow &&
                 * tmpCols<this.rowsize){ for (int i = 0;i < this.rowsize-tmpCols;i++){
