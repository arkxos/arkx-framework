    ...
    public void WriteBits(int bits, int numbits) throws IOException {
        ...
        do {
            ...
            if (numbits <= this.bitsLeft_) {
                int tmp86_83 = this.index_;
                byte[] tmp86_79 = this.buffer_;
                tmp86_79[tmp86_83] = ((byte) (tmp86_79[tmp86_83] | (bits & (1 << numbits) - 1) << 8 - this.bitsLeft_));

                this.bitsLeft_ -= numbits;
                numbits = 0;
            } else {
                int tmp129_126 = this.index_;
                byte[] tmp129_122 = this.buffer_;
                tmp129_122[tmp129_126] = ((byte) (tmp129_122[tmp129_126]
                        | (bits & (1 << this.bitsLeft_) - 1) << 8 - this.bitsLeft_));
