...
/**
 * @class org.ark.framework.utility.XMLLoader xml加载器
 *
 *        使用XMLParser替代
 * @see XMLParser
 * @author Darkness
...
public class XMLLoader {
    ...
    private static ArrayList<TreeNode<String, NodeData>> getChildren(ArrayList<TreeNode<String, NodeData>> parentList,
            String pathPart) {
        ArrayList<TreeNode<String, NodeData>> list = new ArrayList<TreeNode<String, NodeData>>();
