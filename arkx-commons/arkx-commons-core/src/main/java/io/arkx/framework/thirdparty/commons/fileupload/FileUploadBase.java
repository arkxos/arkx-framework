 ...
 * {@link #parseRequest(HttpServletRequest)} to acquire a list of {@link FileItem}s
...
public abstract class FileUploadBase {
	...
	/**
	 * The maximum size permitted for an uploaded file. A value of -1 indicates no
	 * maximum.
	 */
	 ...
	 * part. When not specified, or <code>null</code>, the request encoding is used. If
	 * that is also not specified, or <code>null</code>, the platform default encoding is
	 * used.
	 ...
	 * @return A list of <code>FileItem</code> instances parsed from the request, in the
	 * order that they were transmitted.
	 * @throws FileUploadException if there are problems reading/parsing the request or
	 * storing files.
	...
	public List<FileItem> parseRequest(RequestContext ctx) throws FileUploadException {
		...
		if (sizeMax >= 0 && requestSize > sizeMax) {
			throw new SizeLimitExceededException("the request was rejected because its size (" + requestSize
	...
	protected FileItem createItem(Map<String, String> headers, boolean isFormField) throws FileUploadException {
		return getFileItemFactory().createItem(getFieldName(headers), getHeader(headers, CONTENT_TYPE), isFormField,
				getFileName(headers));
	}
	...
	/**
	 * Returns the header with the specified name from the supplied map. The header lookup
	 * is case-insensitive.
	 * @param headers A <code>Map</code> containing the HTTP request headers.
	 * @param name The name of the header to return.
	 * @return The value of specified header, or a comma-separated list if there were
	 * multiple headers of that name.
	 */
	...
	public static class UnknownSizeException extends FileUploadException {
		...
		/**
		 * Constructs an <code>UnknownSizeException</code> with the specified detail
		 * message.
		 * @param message The detail message.
		 */
