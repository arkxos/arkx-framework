...
public class StringEscapeUtils {
	...
	/**
	 * Translator object for escaping HTML version 4.0. While {@link #escapeHtml4(String)}
	 * is the expected method of use, this object allows the HTML escaping functionality
	 * to be used as the foundation for a custom translator.
	 *
	 * @since 3.0
	 */
	 ...
	 * {@link #unescapeHtml4(String)} is the expected method of use, this object allows
	 * the HTML unescaping functionality to be used as the foundation for a custom
	 * translator.
	 *
	 * @since 3.0
	 */
	 ...
	 * References</a>
	 * @see <a href="http://www.w3.org/TR/html401/charset.html#code-position">HTML 4.01
	 * Code positions</a>
	 * @since 3.0
	 */
