package com.arkxos.framework.ssi;
  ...
  implements SSIExternalResolver
{
  ...
  {
    this.context = context;this.req = req;this.res = res;this.isVirtualWebappRelative = isVirtualWebappRelative;this.debug = debug;this.inputEncoding = inputEncoding;
  }
  ...
  private static CacheMapx<String, Long> timeMap = new CacheMapx(5000);
  private static CacheMapx<String, byte[]> fileMap = new CacheMapx(5000);
