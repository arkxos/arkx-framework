package com.arkxos.framework.data.simplejdbc.sql;
...
public class MySqlPagedHandler implements IPagedHandler {
	...
	@Override
	public PreparedStatement createPagedStatement(Connection conn, String sql, int start, int limit) throws SQLException {
