package com.arkxos.framework.data.fasttable.util;
...
//		FileUtil.mkdir(generateFolder);
		...
		for (Field field : fields) {
			com.arkxos.framework.data.fasttable.annotation.FastColumn fastColumn = field.getDeclaredAnnotation(com.arkxos.framework.data.fasttable.annotation.FastColumn.class);
			if(fastColumn!=null) {
	...
	private static String generateFastColumn(Field field) {
		com.arkxos.framework.data.fasttable.annotation.FastColumn columnDefine = field.getAnnotation(com.arkxos.framework.data.fasttable.annotation.FastColumn.class);
