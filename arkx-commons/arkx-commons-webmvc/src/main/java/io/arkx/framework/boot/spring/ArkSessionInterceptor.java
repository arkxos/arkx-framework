...
public class ArkSessionInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object arg2) throws Exception {
		...
		log.debug("preHandle:["+preCounter.longValue()+"("+session.getConnection().connID+")] " + request.getRequestURI());
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse arg1, Object arg2, ModelAndView arg3)
		...
		if (session != null) {
			log.debug("postHandle:["+postCounter.longValue()+"("+session.getConnection().connID+")] " + request.getRequestURI());
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse arg1, Object arg2, Exception exception)
		...
		log.debug("afterCompletion:["+finishCounter.longValue()+"("+session.getConnection().connID+")] " + request.getRequestURI());
		}
		else {
