package com.arkxos.cloud.platform.common.swagger.config;
...
import com.arkxos.cloud.platform.common.swagger.annotation.EnableArkDoc;
...
public class OpenAPIDefinitionImportSelector implements ImportBeanDefinitionRegistrar {
	...
	public void registerBeanDefinitions(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
		...
		Map<String, Object> annotationAttributes = metadata.getAnnotationAttributes(EnableArkDoc.class.getName(), true);
