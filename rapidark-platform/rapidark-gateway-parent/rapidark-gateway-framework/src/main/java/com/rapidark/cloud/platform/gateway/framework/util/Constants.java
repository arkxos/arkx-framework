...
public class Constants {
    ...
    public static final String RULE_ERROR = "Rule-Error";
    public static final String GATEWAY_CACHE = "gateway-cache";
    public static final String GATEWAY_CACHE_KEY = "gateway-cache-key";
    public static final String GATEWAY_MAX_AGE = "gateway-max-age";
