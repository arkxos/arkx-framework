...
public class LogGlobalFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        return completeMono.doFinally(signal -> {
            ...
            //创建自定义请求监控日志
            //114.67.85.24 - - [03/Dec/2019:23:53:06 +0800] "GET /index.php HTTP/1.1" 200 0 114.67.101.85 "http://127.0.0.1:8080/index.php" "Mozilla/4.0 (compatible; MSIE 9.0; Windows NT 6.1)" "0.000"
