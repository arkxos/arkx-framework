...
insert  into `client`(`id`,`systemCode`,`name`,`groupCode`,`ip`,`status`,`createTime`,`updateTime`,`remarks`) values ('c7473ec4be7544fc95986ad070ab7c06','RiskManage','风控系统','interior_api','127.0.0.1','0','2020-12-30 16:21:41','2021-09-26 15:44:31','风险分析与风险实时监控系统。负责人：徐某');
...
insert  into `route`(`id`,`systemCode`,`name`,`groupCode`,`uri`,`path`,`method`,`host`,`remoteAddr`,`header`,`filterGatewaName`,`filterHystrixName`,`filterRateLimiterName`,`filterAuthorizeName`,`fallbackMsg`,`fallbackTimeout`,`replenishRate`,`burstCapacity`,`weight`,`status`,`stripPrefix`,`requestParameter`,`rewritePath`,`accessHeader`,`accessIp`,`accessParameter`,`accessTime`,`accessCookie`,`createTime`,`updateTime`) values ('EXAMPLES-getUser','CRM','用户管理服务-获取用户','interior_api','lb://provider-examples','/proxy/userCenter/getUser','','','','','',NULL,NULL,'','',0,20,100,NULL,'0',1,'','','','','','','','2021-10-13 19:53:50','2021-10-13 20:14:52'),('userCenter-addUser','CRM','用户管理系统-添加用户','interior_api','http://127.0.0.1:8769','/route/userCenter/addUser','POST',NULL,NULL,NULL,'',NULL,NULL,'','',0,20,100,NULL,'1',1,'',NULL,'','','','','','2020-12-30 15:37:00','2021-09-26 20:11:14'),('userCenter-delUser','CRM','用户管理系统-删除用户','interior_api','http://127.0.0.1:8769','/route/userCenter/delUser','GET',NULL,NULL,NULL,'',NULL,NULL,'','',0,20,100,NULL,'1',1,'',NULL,'','','','','','2020-12-30 15:35:22','2021-09-26 20:15:57'),('userCenter-feign','CRM','用户管理系统-Feign获取用户信息','interior_api','lb://consumer-examples','/route/userCenter/feign/getUser','GET','','','','','custom',NULL,'','',5000,20,100,NULL,'0',1,'version,snapshot-nacos.v.3.1','','','','','','','2021-02-01 17:33:38','2021-10-13 20:15:06'),('userCenter-getToken','CRM','用户管理系统-获取Token','interior_api','http://127.0.0.1:8769','/route/userCenter/getToken','','127.0.0.1:8771','127.0.0.1','X-Request-Id,userCenter-getToken','',NULL,NULL,'','',0,20,100,NULL,'0',1,'version,snapshot-nacos.v.3.1','/userCenter(?<segment>.*),/producer$\\{segment}','','','','','','2020-12-30 15:40:11','2021-09-27 14:57:38'),('userCenter-getUser','CRM','用户管理系统-获取用户','interior_api','http://127.0.0.1:8769','/route/userCenter/getUser','',NULL,NULL,NULL,'id,ip,token',NULL,NULL,'','',0,10,10,NULL,'0',1,'',NULL,'','','','','','2020-12-30 15:34:25','2021-09-30 15:13:42'),('userCenter-regUser','CRM','用户管理系统-注册用户','interior_api','http://127.0.0.1:8769','/route/userCenter/regUser','POST',NULL,NULL,NULL,'',NULL,NULL,'','',0,20,100,NULL,'1',1,'',NULL,'','','','','','2020-12-30 15:33:01','2021-09-26 20:18:01');

/*Data for the table `secureip` */

insert  into `secureip`(`ip`,`status`,`createTime`,`updateTime`,`remarks`) values ('127.0.0.1','0','2020-12-30 16:39:39','2020-12-30 16:50:25','非法IP');
