...
//import com.rapidark.cloud.generator.server.mybatisplus.controller.cmd.GenerateCodeCommand;
//import com.rapidark.cloud.generator.server.mybatisplus.controller.param.QueryTablesParams;
...
//import com.rapidark.cloud.generator.server.utils.ZipUtil;
//
...
//     * @return
//     */
//    @Schema(title = "获取所有表信息", name = "获取所有表信息")
//    @PostMapping("/tables")
...
//    }
//
//    @Schema(title = "代码生成并下载", name = "代码生成并下载")
//    @PostMapping("/execute")
