package com.rapidark.cloud.generator.server.mybatisplus.service;
...
public class GeneratorService {
    public static void execute(GenerateConfig generateConfig) {
        ...
        // mapper 父类
        strategy.setSuperMapperClass("com.rapidark.cloud.common.mybatis.base.mapper.SuperMapper");
        // 实体父类
        strategy.setSuperEntityClass("com.rapidark.cloud.common.mybatis.base.entity.AbstractEntity");
        // 接口父类
        strategy.setSuperServiceClass("com.rapidark.cloud.common.mybatis.base.service.IBaseService");
        // 接口实现类父类
        strategy.setSuperServiceImplClass("com.rapidark.cloud.common.mybatis.base.service.impl.BaseServiceImpl");
        // 需要生成的表
