 ...
 * @date 2021/12/21
 */
public interface ArkUserDetailsService extends UserDetailsService, Ordered {
	 ...
	 * @return
	 */
	default UserDetails loadUserByUser(ArkUser arkUser) {
		return this.loadUserByUsername(arkUser.getUsername());
	}
