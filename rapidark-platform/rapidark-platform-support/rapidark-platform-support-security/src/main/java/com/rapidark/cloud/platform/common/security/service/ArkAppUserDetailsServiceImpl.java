...
package com.rapidark.cloud.platform.common.security.service;

import com.rapidark.platform.system.api.dto.UserDTO;
import com.rapidark.platform.system.api.dto.UserInfo;
import com.rapidark.platform.system.api.feign.RemoteUserService;
...
public class ArkAppUserDetailsServiceImpl implements ArkUserDetailsService {
	...
	public UserDetails loadUserByUsername(String phone) {
		...
		if (cache != null && cache.get(phone) != null) {
			return (ArkUser) cache.get(phone).get();
		}
	 ...
	 */
	@Override
	public UserDetails loadUserByUser(ArkUser arkUser) {
		return this.loadUserByUsername(arkUser.getPhone());
	}
