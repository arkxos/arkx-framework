package com.rapidark.cloud.platform.codegen.config;
...
@ConfigurationProperties(prefix = ArkCodeGenDefaultProperties.PREFIX)
public class ArkCodeGenDefaultProperties implements InitializingBean {
	 ...
	 * 生成代码的后端路径
	 */
	private String backendPath = "rapidark";
	 ...
	 * 生成代码的作者
	 */
	private String author = "rapidark";

	/**
	 * 生成代码的邮箱
	 */
	private String email = "sw@rapidark.com";
