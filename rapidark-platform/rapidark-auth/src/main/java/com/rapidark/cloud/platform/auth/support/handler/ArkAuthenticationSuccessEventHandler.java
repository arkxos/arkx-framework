...
import com.rapidark.cloud.platform.common.log.util.SysLogUtils;
import com.rapidark.cloud.platform.common.security.component.ArkCustomOAuth2AccessTokenResponseHttpMessageConverter;
 ...
 */
@Slf4j
public class ArkAuthenticationSuccessEventHandler implements AuthenticationSuccessHandler {

	private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new ArkCustomOAuth2AccessTokenResponseHttpMessageConverter();
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		if (MapUtil.isNotEmpty(map)) {
			// 发送异步日志事件
			ArkUser userInfo = (ArkUser) map.get(SecurityConstants.DETAILS_USER);
