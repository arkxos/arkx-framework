...
import com.rapidark.cloud.platform.admin.api.vo.TokenVo;
...
import com.rapidark.cloud.platform.common.security.util.OAuth2ErrorCodesExpand;
import com.rapidark.cloud.platform.common.security.util.OAuthClientException;
...
public class ArkTokenEndpoint {

	private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new OAuth2AccessTokenResponseHttpMessageConverter();

	private final AuthenticationFailureHandler authenticationFailureHandler = new ArkAuthenticationFailureEventHandler();
