...
public class OpenApp extends AbstractIdStringEntity {
    ...
    @NotBlank
    @Schema(title = "app类型:server-服务应用 app-手机应用 pc-PC网页应用 wap-手机网页应用")
     ...
     */
    @Column(name = "APP_OS")
    @Schema(title = "移动应用操作系统:ios-苹果 android-安卓")
    ...
    @NotNull
    @Schema(title = "是否验签:0-否 1-是 不允许删除")
    ...
    @NotNull
    @Schema(title = "是否加密:0-否 1-是 不允许删除")
    ...
    @NotBlank
    @Schema(title = "加密类型:DES TripleDES AES RSA")
