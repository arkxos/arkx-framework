package com.rapidark.framework.cosyui.control.tree;
...
public class Tree {
	...
	public Tree(DataTable dataTable) {
		this.data = com.rapidark.framework.json.JSON.toJSONString(dataTable);
	}
	...
	public DataTable getDataTable() {
		DataTable dataTable = com.rapidark.framework.json.JSON.parseBean(data, DataTable.class);
		return dataTable;
	}
