...
//package com.rapidark.infinity.common.download;
//
...
//
//import com.rapidark.infinity.common.task.Element;
//import com.rapidark.infinity.common.task.ElementProcessor;
//import com.rapidark.infinity.common.task.MultiThreadedQueueExecutor;
//import com.rapidark.infinity.common.task.QueueExecuteFinishHandler;
//
//public class DownloadScheduler {
//
//	private MultiThreadedQueueExecutor<RemoteHttpPartFile> taskEnginer;
//	
////	private ThreadPoolExecutor executor;
//	
////	private ConcurrentHashMap<Future<?>, RemoteHttpPartFile> workerFuturesMap = new ConcurrentHashMap<>();
...
////				RemoteHttpPartFile worker = workerFuturesMap.get(workerFuture);
////				RemoteHttpPartFile splitWorker = worker.split();
////				if (splitWorker != null) {
////					push(splitWorker);
////					break;
////				}
...
////	}
//
//	public Future<?> push(RemoteHttpPartFile remoteHttpPartFile) {
//		
