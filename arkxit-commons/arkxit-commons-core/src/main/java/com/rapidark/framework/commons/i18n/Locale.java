package com.rapidark.framework.commons.i18n;
...
public class Locale {
	 ...
	 * 
	 * The first argument will replace <code>%1</code> and the second argument will replace <code>%2</code>.
	 * 
	 * @param key a key which represents a line of text
	 * @param arg1 the first argument
	 ...
	 * <pre>%1 of %2 (%3%)</pre>
	 * 
	 * The first argument will replace <code>%1</code> and the second argument will replace <code>%2</code> and the third argument will replace <code>%3</code>.
	 * 
	 * @param key a key which represents a line of text
	 * @param arg1 the first argument
	 * @param arg2 the second argument
