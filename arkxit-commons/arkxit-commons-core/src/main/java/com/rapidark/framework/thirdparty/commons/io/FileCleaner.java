 ...
 * <p>
 * This utility creates a background thread to handle file deletion. Each file to be deleted is registered with a handler object. When the
 * handler object is garbage collected, the file is deleted.
 * 
 * @author Noel Bergman
...
public class FileCleaner {
	...
	private static class Tracker extends PhantomReference<Object> {
		 ...
		 * 
		 * @return <code>true</code> if the file was deleted successfully; <code>false</code> otherwise.
		 */
