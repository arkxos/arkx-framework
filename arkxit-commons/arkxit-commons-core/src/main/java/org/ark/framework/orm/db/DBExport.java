...
//		
//		String classGeneratePath = Config.getClassesPath() + "schema_generate_temp/" + packageName().replaceAll("\\.", "/");
...
//		}
//		classGenerator.generate(classGeneratePath, packageName(), database.getTables());
//	}
//
//	/**
//	 * 导出过程中生成的java文件所属包
...
//		return "org.ark." + database.getConfig().getDatabaseName().toLowerCase() + ".schema";
//	}
//
//}
