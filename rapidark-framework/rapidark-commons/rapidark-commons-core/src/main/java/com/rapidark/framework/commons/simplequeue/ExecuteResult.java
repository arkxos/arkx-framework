 ...
 * {@link #getResultItems()} get extract results to be used in {@link com.rapidark.framework.commons.simplequeue.pipeline.Pipeline}<br>
 * {@link #addTargetRequests(java.util.List)} {@link #addTargetRequest(String)} add urls to fetch                 <br>
 *
 * @author code4crafter@gmail.com <br>
 * @see com.rapidark.framework.commons.simplequeue.ElementProcessor
