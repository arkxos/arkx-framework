...
public class EntityAnnotationManager {
	...
	public static <T extends Entity> String getTableName(Class<T> clazz) {
		...
		String tableName = "";
		if (clazz.isAnnotationPresent(com.rapidark.framework.annotation.Entity.class)) {
			 tableName = clazz.getAnnotation(com.rapidark.framework.annotation.Entity.class).name();
		} else {
