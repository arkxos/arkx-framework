...
public class PackageUtil {
    ...
    public static List<String> findPackageClass(String scanPackages) {
        ...
        List<String> clazzSet = new ArrayList<>();
     ...
     * @return 返回检查后有效的路径集合
     */
    private static List<String> checkPackage(String scanPackages) {
        if (StringUtils.isBlank(scanPackages)) {
            return new ArrayList<>();
        }
    ...
    public static void main(String[] args) {
        String packages = "com.rapidark";//,com.ab,com.c,com.as.t,com.as,com.as.ta,com.at.ja,com.at.jc,com.at.";
