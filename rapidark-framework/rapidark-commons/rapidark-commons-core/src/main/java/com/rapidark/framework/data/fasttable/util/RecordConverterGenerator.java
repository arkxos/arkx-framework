package com.rapidark.framework.data.fasttable.util;
...
//		FileUtil.mkdir(generateFolder);
		...
		for (Field field : fields) {
			com.rapidark.framework.data.fasttable.annotation.FastColumn fastColumn = field.getDeclaredAnnotation(com.rapidark.framework.data.fasttable.annotation.FastColumn.class);
			if(fastColumn!=null) {
	...
	private static String generateFastColumn(Field field) {
		com.rapidark.framework.data.fasttable.annotation.FastColumn columnDefine = field.getAnnotation(com.rapidark.framework.data.fasttable.annotation.FastColumn.class);
