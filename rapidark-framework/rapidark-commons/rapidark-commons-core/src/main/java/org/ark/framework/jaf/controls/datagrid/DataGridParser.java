...
//
//		dataGridAction.Table.setAttribute("SortString", dataGrid.getSortString().toString());
//
...
//		dataGridAction.Table.setAttribute("autopagesize", dataGridAction.autoPageSize);
