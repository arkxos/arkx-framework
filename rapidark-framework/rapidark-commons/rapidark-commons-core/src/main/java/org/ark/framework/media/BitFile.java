  ...
  public void WriteBits(int bits, int numbits) throws IOException {
    ...
    do {
      ...
      if (numbits <= this.bitsLeft_)
      {
        ...
        byte[] tmp91_84 = this.buffer_; tmp91_84[tmp91_88] = (byte)(tmp91_84[tmp91_88] | (bits & (1 << numbits) - 1) << 8 - this.bitsLeft_);
        bitsWritten += numbits;
      ...
      else
      {
        ...
        byte[] tmp138_131 = this.buffer_; tmp138_131[tmp138_135] = (byte)(tmp138_131[tmp138_135] | (bits & (1 << this.bitsLeft_) - 1) << 8 - this.bitsLeft_);
