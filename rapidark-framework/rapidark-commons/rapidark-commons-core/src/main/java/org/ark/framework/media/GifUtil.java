...
public class GifUtil
{
  ...
  public static void resizeByRate(String srcFile, String destFile, double wRatio, double hRatio) throws IOException, AWTException
  {
  ...
  public static void resizeByRate(String srcFile, String destFile, int width, int height, boolean keepRate) throws IOException, AWTException
  {
    BufferedInputStream is = new BufferedInputStream(new FileInputStream(srcFile));
    GifDecoder decoder = new GifDecoder();
    decoder.read(is);
