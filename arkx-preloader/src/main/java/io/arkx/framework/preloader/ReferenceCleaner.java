...
public class ReferenceCleaner {
    ...
    private final void clearReferencesJdbc() {
        ...
        try {
            ...
            List driverNames = (List) obj.getClass().getMethod("clearJdbcDriverRegistrations", new Class[0]).invoke(obj,
                    new Object[0]);
            String name;
                ...
                if (clear) {
                    if (thread.getClass().getName().startsWith("java.util.Timer")) {
                        ...
                        try {
                            ...
                            if ((target != null) && (target.getClass().getCanonicalName() != null) && (target.getClass()
                                    .getCanonicalName().equals("java.util.concurrent.ThreadPoolExecutor.Worker"))) {
