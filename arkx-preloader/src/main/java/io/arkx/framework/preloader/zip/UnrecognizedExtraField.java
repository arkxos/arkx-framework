 ...
 *
 * <p>
 * Assumes local file data and central directory entries are identical - unless told the
 * opposite.
 * </p>
 *
 */
public class UnrecognizedExtraField implements CentralDirectoryParsingZipExtraField {
	...
	/**
	 * Get the central data length. If there is no central data, get the local file data
	 * length.
