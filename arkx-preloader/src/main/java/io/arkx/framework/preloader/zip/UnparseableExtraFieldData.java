...
/**
 * Wrapper for extra field data that doesn't conform to the recommended format of
 * header-tag + size + data.
 *
 * <p>
 * The header-id is artificial (and not listed as a know ID in the .ZIP File Format
 * Specification). Since it isn't used anywhere except to satisfy the ZipExtraField
 * contract it shouldn't matter anyway.
 * </p>
 *
 * @see <a href="http://www.pkware.com/documents/casestudies/APPNOTE.TXT APPNOTE.TXT">.ZIP
