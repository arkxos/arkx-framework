...
public class ZipFile {
    ...
    /**
     * Opens the given file for reading, assuming the platform's native encoding for
     * file names.
     *
     * @param f
     *            the archive.
     ...
     * names, scanning unicode extra fields.
     *
     * @param name
     *            name of the archive.
     * @param encoding
    ...
    /**
     * Opens the given file for reading, assuming the specified encoding for file
     * names and scanning for unicode extra fields.
     *
     * @param f
     *            the archive.
     * @param encoding
     *            the encoding to use for file names, use null for the platform's
     *            default encoding
     * @throws IOException
     *             if an error occurs while reading the file.
     */
     ...
     *            whether to use InfoZIP Unicode Extra Fields (if present) to set
     *            the file names.
     * @throws IOException
     *             if an error occurs while reading the file.
     */
     ...
     * </p>
     *
     * @return a Map&lt;ZipEntry, NameAndComment>&gt; of zipentries that didn't have
     *         the language encoding flag set when read.
     */
    ...
    private static final int MIN_EOCD_SIZE = /* end of central dir signature */ WORD/* number of this disk */ + SHORT
    ...
    private static final int MAX_EOCD_SIZE = MIN_EOCD_SIZE/* maximum length of zipfile comment */ + 0xFFFF;
    ...
    private static final long LFH_OFFSET_FOR_FILENAME_LENGTH = /*
                                                                ...
                                                                */ WORD/* version needed to extract */ + SHORT
    /* general purpose bit flag */ + SHORT
    /* compression method */ + SHORT
    /* last mod file time */ + SHORT
    /* last mod file date */ + SHORT
    ...
    /**
     * Walks through all recorded entries and adds the data available from the local
     * file header.
     *
     * <p>
     ...
     * those of the extra fields, transfer the known Unicode values from the extra
     * field.
     */
    ...
    /**
     * If the stored CRC matches the one of the given name, return the Unicode name
     * of the given field.
     *
     * <p>
