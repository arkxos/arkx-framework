 ...
 *
 * <p>
 * This implementation is not favorable for encodings other than utf-8, because java.io
 * encodes unmappable character as question marks leading to unreadable ZIP entries on
 * some operating systems.
 * </p>
 *
 * <p>
 * Furthermore this implementation is unable to tell, whether a given name can be safely
 * encoded or not.
 * </p>
 *
 * <p>
...
class FallbackZipEncoding implements ZipEncoding {
	 ...
	 * @param charset The name of the charset or <code>null</code> for the platform's
