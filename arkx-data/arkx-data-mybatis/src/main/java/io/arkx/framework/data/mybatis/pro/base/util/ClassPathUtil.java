package io.arkx.framework.data.mybatis.pro.base.util;
...
public class ClassPathUtil {
    ...
    public static String[] resolvePackage(String packagePath) {
        ...
        // 解析路径
        packagePath = ResourcePatternResolver.CLASSPATH_ALL_URL_PREFIX
                + ClassUtils.convertClassNameToResourcePath(packagePath) + File.separator + DEFAULT_RESOURCE_PATTERN;
        // 别名包路径集合
