 ...
 * <p>
 * 开发JacksonDeserializer的灵感来源于这里：<a href=
 * "https://www.cnblogs.com/kelelipeng/p/13972138.html">https://www.cnblogs.com/kelelipeng/p/13972138.html</a>，
 * <p>
 ...
 * </pre>
 *
 * 3. 对于枚举类型fastjson和jackson选型问题，fastjson存在的问题： 1. 列表方式的枚举反序列化会oom； 2.
 * 枚举类型传<code>null</code>会有默认认知0造成业务出错，业务中如果允许Gender为空，前端传{"gender":
 * null}，那么gender就是0对应的枚举，而jackson就不会
 *
 * <pre>
 * public class Demo {
 ...
 *
 * 3.
 * 并且通过{@link io.arkx.framework.data.mybatis.pro.base.codec.enums.EnumMarkerDeserializerForCollection}能够解决列表方式的枚举问题，而fastjson的oom就不太好解决
