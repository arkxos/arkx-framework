...
public class ProductServiceTest {
	...
	void createProduct_ShouldReturnSavedProduct() {
		ProductDTO inputDTO = new ProductDTO(null, "New Product", "Desc", 99.99, "Category", true);
	...
	void updateProduct_ExistingId_ShouldReturnUpdatedProduct() {
		...
		Product existingEntity = Product.builder()
				...
				.active(false)
				.build();
		ProductDTO inputDTO = new ProductDTO(productId, "New Name", "New Desc", 100.0, "New Category", true);
