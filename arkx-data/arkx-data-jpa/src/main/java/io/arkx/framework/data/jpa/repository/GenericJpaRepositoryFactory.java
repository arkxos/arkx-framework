...
// private Map<Class<?>, List<EntityAssembler>> assemblers = new
// ConcurrentHashMap<>();
//
// /**
...
//
// @Override
// protected Optional<QueryLookupStrategy> getQueryLookupStrategy(@Nullable
// QueryLookupStrategy.Key key,
// QueryMethodEvaluationContextProvider evaluationContextProvider) {
// return Optional.of(TemplateQueryLookupStrategy.create(entityManager, key,
...
// Collection<EntityAssembler> abs =
// ContextHolder.getBeansOfType(EntityAssembler.class);
// if (abs.isEmpty()) {
// return Collections.emptyList();
// } else {
// for (EntityAssembler ab : abs) {
// Class p0 = getGenericParameter0(ab.getClass());
// List<EntityAssembler> ass = this.assemblers.computeIfAbsent(p0, k -> new
// ArrayList<>());
// ass.add(ab);
// }
// for (List<EntityAssembler> ess : assemblers.values()) {
// ess.sort((o1, o2) -> OrderUtils.getOrder(o2.getClass()) -
// OrderUtils.getOrder(o1.getClass()));
// }
// }
// }
...
// getEntityAssemblers(object.getClass());
...
// return object != null && AnnotationUtils.findAnnotation(object.getClass(),
// Entity.class) != null;
// }
//
// /**
...
// clzz.getGenericSuperclass()).getActualTypeArguments()[0];
// }
//
// /**
// * 对象组装拦截器.
...
// List<EntityAssembler> entityAssemblers =
// getEntityAssemblers(proceed.getClass());
// if (!CollectionUtils.isEmpty(entityAssemblers)) {
// for (EntityAssembler assembler : entityAssemblers) {
