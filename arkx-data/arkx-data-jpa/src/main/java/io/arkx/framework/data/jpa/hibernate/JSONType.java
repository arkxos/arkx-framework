...
public class JSONType implements UserType, DynamicParameterizedType, Serializable {
	...
	public Object deepCopy(Object value) throws HibernateException {
		return value;
		/*
		 * if (value instanceof JSONObject) { return ((JSONObject) value).clone(); } else
		 * if (value instanceof Cloneable) { return ObjectUtils.clone(value); } else if
		 * (value instanceof Serializable) { return
