...
// private static final char[] ZEROS = new char[]{'0', '0', '0', '0', '0', '0',
//// '0', '0', '0'};
...
//
// public TimestampUtils(boolean usesDouble, Provider<TimeZone>
//// timeZoneProvider) {
...
// if (sep != '-') {
// throw new NumberFormatException("Expected date to be dash-separated, got '" +
//// sep + "'");
// }
//
// start = end + 1;
...
// char sep = charAt(s, end);
// if (sep != ':') {
// throw new NumberFormatException("Expected time to be colon-separated, got '"
//// + sep + "'");
// }
//
// start = end + 1;
...
//
// if (start < slen) {
// throw new NumberFormatException("Trailing junk on timestamp: '" + new
//// String(s, start, slen - start) + "'");
...
// throw new KSQLException(GT.tr("Bad value for type timestamp/date/time: {1}",
//// new Object[]{str}), KSQLState.BAD_DATETIME_FORMAT, nfe);
// }
// }
//
// public synchronized Timestamp toTimestamp(Calendar cal, String s) throws
//// SQLException {
// if (s == null) {
// return null;
// } else {
...
// throw new KSQLException(GT.tr("Bad value for type timestamp/date/time: {1}",
//// new Object[]{s}), KSQLState.BAD_DATETIME_FORMAT, nfe);
// }
// }
// }
//
...
// } else {
// ParsedTimestamp ts = this.parseBackendTimestamp(s);
// LocalDateTime result = LocalDateTime.of(ts.year, ts.month, ts.day, ts.hour,
//// ts.minute, ts.second, ts.nanos);
// return ts.era == 0 ? result.with(ChronoField.ERA,
//// (long)IsoEra.BCE.getValue()) : result;
// }
// }
// }
//
...
// OffsetDateTime result = OffsetDateTime.of(ts.year, ts.month, ts.day, ts.hour,
//// ts.minute, ts.second, ts.nanos,
//// zoneOffset).withOffsetSameInstant(ZoneOffset.UTC);
// return ts.era == 0 ? result.with(ChronoField.ERA,
//// (long)IsoEra.BCE.getValue()) : result;
// }
// }
...
// return t.toLocalTime().atDate(LocalDate.of(1970, 1,
//// 1)).atOffset(ZoneOffset.UTC);
// }
//
// public OffsetDateTime toOffsetDateTimeBin(byte[] bytes) throws KSQLException
//// {
// ParsedBinaryTimestamp parsedTimestamp =
//// this.toProlepticParsedTimestampBin(bytes);
...
// return OffsetDateTime.MIN;
// } else {
// Instant instant = Instant.ofEpochSecond(parsedTimestamp.millis / 1000L,
//// (long)parsedTimestamp.nanos);
...
// return ts.tz == null && (ts.year != 1970 || ts.era != 1) ?
//// this.convertToTime(timeMillis, useCal.getTimeZone()) : new
//// Time(timeMillis);
// }
// }
//
...
// return timestamp == null ? null : this.convertToDate(timestamp.getTime(), cal
//// == null ? null : cal.getTimeZone());
// }
//
...
// }
//
// public synchronized String toString(Calendar cal, Timestamp x, boolean
//// withTimeZone) {
...
// }
//
// public synchronized String toString(Calendar cal, Date x, boolean
//// withTimeZone) {
// if (x.getTime() == 9223372036825200000L) {
// return "infinity";
// } else if (x.getTime() == -9223372036832400000L) {
...
// }
//
// public synchronized String toString(Calendar cal, Time x, boolean
//// withTimeZone) {
// cal = this.setupCalendar(cal);
// cal.setTime(x);
// this.sbuf.setLength(0);
...
// }
//
// private static void appendDate(StringBuilder sb, int year, int month, int
//// day) {
...
// }
//
// private static void appendTime(StringBuilder sb, int hours, int minutes, int
//// seconds, int nanos) {
...
//// localDateTime.atZone(this.getDefaultTz().toZoneId());
...
// if (bytes.length != 4) {
// throw new KSQLException(GT.tr("Unsupported binary encoding of {0}.", new
//// Object[]{"date"}), KSQLState.BAD_DATETIME_FORMAT);
// } else {
...
//// (TimeZone)DEFAULT_TIME_ZONE_FIELD.get((Object)null);
...
// throw new KSQLException(GT.tr("Unsupported binary encoding of {0}.", new
//// Object[]{"time"}), KSQLState.BAD_DATETIME_FORMAT);
// } else {
// long millis;
// if (this.usesDouble) {
...
// }
//
// public Timestamp toTimestampBin(TimeZone tz, byte[] bytes, boolean
//// timestamptz) throws KSQLException {
// ParsedBinaryTimestamp parsedTimestamp = this.toParsedTimestampBin(tz, bytes,
//// timestamptz);
// if (parsedTimestamp.infinity == TimestampUtils.Infinity.POSITIVE) {
// return new Timestamp(9223372036825200000L);
// } else if (parsedTimestamp.infinity == TimestampUtils.Infinity.NEGATIVE) {
...
// }
//
// private ParsedBinaryTimestamp toParsedTimestampBinPlain(byte[] bytes) throws
//// KSQLException {
// if (bytes.length != 8) {
// throw new KSQLException(GT.tr("Unsupported binary encoding of {0}.", new
//// Object[]{"timestamp"}), KSQLState.BAD_DATETIME_FORMAT);
// } else {
// long secs;
// int nanos;
// if (this.usesDouble) {
...
//// boolean timestamptz) throws KSQLException {
...
// return LocalDateTime.MAX;
// } else {
// return parsedTimestamp.infinity == TimestampUtils.Infinity.NEGATIVE ?
//// LocalDateTime.MIN : LocalDateTime.ofEpochSecond(parsedTimestamp.millis /
//// 1000L, parsedTimestamp.nanos, ZoneOffset.UTC);
// }
// }
//
...
// } else {
// return time instanceof Time t ? this.toString(cal, t, withTimeZone) :
//// this.toString(cal, (Date)time, withTimeZone);
// }
// }
//
...
// MIN_LOCAL_DATE = LocalDate.of(4713, 1, 1).with(ChronoField.ERA,
//// (long)IsoEra.BCE.getValue());
