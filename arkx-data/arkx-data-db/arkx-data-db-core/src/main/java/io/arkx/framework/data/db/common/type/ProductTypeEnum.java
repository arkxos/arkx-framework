...
public enum ProductTypeEnum {
	 ...
	 * MySQL数据库类型
	 */
	MYSQL(1, "`", "MySQL", "com.mysql.cj.jdbc.Driver", 3306, "/* ping */ SELECT 1", "jdbc:mysql://",
	 ...
	 * MariaDB数据库类型
	 */
	MARIADB(2, "`", "MariaDB", "org.mariadb.jdbc.Driver", 3306, "SELECT 1", "jdbc:mariadb://",
	 ...
	 * Oracle数据库类型
	 */
	ORACLE(3, "\"", "Oracle", "oracle.jdbc.driver.OracleDriver", 1521, "SELECT 'Hello' from DUAL", "jdbc:oracle:thin:@",
	 ...
	 * PostgreSQL数据库类型
	 */
	POSTGRESQL(5, "\"", "PostgreSql", "org.postgresql.Driver", 5432, "SELECT 1", "jdbc:postgresql://",
	 ...
	 * DB2数据库类型
	 */
	DB2(6, "\"", "DB2", "com.ibm.db2.jcc.DB2Driver", 50000, "SELECT 1 FROM SYSIBM.SYSDUMMY1", "jdbc:db2://",
	 ...
	 * [国产] 达梦(DM)数据库类型
	 */
	DM(7, "\"", "DM", "dm.jdbc.driver.DmDriver", 5236, "SELECT 'Hello' from DUAL", "jdbc:dm://",
			new String[] { "jdbc:dm://{host}:{port}[/{database}][\\?{params}]" }, "jdbc:dm://127.0.0.1:5236"),

	/**
	 * [国产] 金仓(Kingbase)数据库类型
	 */
	KINGBASE(8, "\"", "KingBase", "com.kingbase8.Driver", 54321, "SELECT 1", "jdbc:kingbase8://",
	 ...
	 * [国产] 神通(Oscar)数据库类型
	 */
	OSCAR(9, "\"", "Oscar", "com.oscar.Driver", 2003, "SELECT 1", "jdbc:oscar://",
	 ...
	 */
	GBASE8A(10, "`", "GBase8A", "com.gbase.jdbc.Driver", 5258, "/* ping */ SELECT 1", "jdbc:gbase://",
	 ...
	 */
	HIGHGO(11, "\"", "HighGo", "com.highgo.jdbc.Driver", 5866, "SELECT 1", "jdbc:highgo://",
	 ...
	 * Sybase 数据库类型
	 */
	SYBASE(12, "\"", "Sybase", "com.sybase.jdbc4.jdbc.SybDriver", 5000, "SELECT 1+2 as a", "jdbc:sybase:Tds:",
	 ...
	 * Hive 数据库类型
	 */
	HIVE(13, "`", "Hive", "org.apache.hive.jdbc.HiveDriver", 10000, "SELECT 1", "jdbc:hive2://",
	...
	SQLITE3(14, "\"", "Sqlite3", "org.sqlite.JDBC", 0, "SELECT 1", "jdbc:sqlite:",
			new String[] { "jdbc:sqlite:{file}", "jdbc:sqlite::resource:{file}" }, "jdbc:sqlite:/tmp/test.db"),

	/**
	 * OpenGauss数据库类型
	 */
	OPENGAUSS(15, "\"", "OpenGauss", "org.opengauss.Driver", 15432, "SELECT 1", "jdbc:opengauss://",
	 ...
	 * ClickHouse数据库类型
	 */
	CLICKHOUSE(16, "`", "ClickHouse", "com.clickhouse.jdbc.ClickHouseDriver", 8123, "SELECT 1", "jdbc:clickhouse://",
	 ...
	 * MongoDB数据库类型
	 */
	MONGODB(17, "\"", "MongoDB", "com.gitee.jdbc.mongodb.JdbcDriver", 27017, "use admin;", "jdbc:mongodb://",
	 ...
	 * ElasticSearch数据库类型
	 */
	ELASTICSEARCH(18, "\"", "ElasticSearch", "com.gitee.jdbc.elasticsearch.JdbcDriver", 9200, "", "jdbc:jest://",
			new String[] { "jdbc:jest://{host}[:{port}][\\?{params}]" }, "jdbc:jest://172.17.2.12:9200?useHttps=false"),

	/**
	 * StarRocks数据库类型
	 */
	STARROCKS(19, "`", "StarRocks", "com.mysql.cj.jdbc.Driver", 9030, "/* ping */ SELECT 1", "jdbc:mysql://",
			new String[] { "jdbc:mysql://{host}[:{port}]/[{database}][\\?{params}]" },
	 ...
	 * Greenplum数据库类型
	 */
	GREENPLUM(20, "\"", "Greenplum", "org.postgresql.Driver", 5432, "SELECT 1", "jdbc:postgresql://",
			new String[] { "jdbc:postgresql://{host}[:{port}]/[{database}][\\?{params}]" },
			"jdbc:postgresql://127.0.0.1:5432/test"),
	 ...
	 * DORIS数据库类型
	 */
	DORIS(21, "`", "Doris", "com.mysql.cj.jdbc.Driver", 9030, "/* ping */ SELECT 1", "jdbc:mysql://",
			new String[] { "jdbc:mysql://{host}[:{port}]/[{database}][\\?{params}]" },
			"jdbc:mysql://127.0.0.1:9030/test?useUnicode=true&characterEncoding=utf-8&useSSL=false&zeroDateTimeBehavior=convertToNull&serverTimezone=Asia/Shanghai&tinyInt1isBit=false&rewriteBatchedStatements=true&useCompression=true"),
	 ...
	 * OceanBase数据库类型
	 */
	OCEANBASE(22, "", "OceanBase", "com.oceanbase.jdbc.Driver", 2881, "/* ping */", "jdbc:oceanbase://",
	 ...
	 * TDengine 数据库类型
	 */
	TDENGINE(23, "`", "TDengine", "com.taosdata.jdbc.rs.RestfulDriver", 6041, "/* ping */ SELECT 1", "jdbc:TAOS-RS://",
	...
	public boolean noCommentStatement() {
		return Arrays
			.asList(ProductTypeEnum.MYSQL, ProductTypeEnum.MARIADB, ProductTypeEnum.GBASE8A, ProductTypeEnum.HIVE,
					ProductTypeEnum.SQLITE3, ProductTypeEnum.SYBASE)
			.contains(this);
	}
