...
import io.arkx.framework.data.db.common.entity.PatternMapper;
...
public final class PatterNameUtils {
    ...
    public static void main(String[] args) {
        ...
        // 匹配的名字替换
        System.out.println(getFinalName("hello", Arrays.asList(new PatternMapper("hello", "new_hello"))));

        // 不匹配的名字不替换
        System.out.println(getFinalName("test", Arrays.asList(new PatternMapper("hello", "new_hello"))));
    }
