...
public final class ObjectCastUtils {
    ...
    public static Byte castToByte(final Object in) {
        if (in instanceof Number number) {
            ...
            try {
                ...
                throw new RuntimeException("无法将java.lang.String类型转换为java.lang.Byte类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof Character) {
            try {
                return Byte.parseByte(in.toString());
            } catch (NumberFormatException e) {
                throw new RuntimeException("无法将java.lang.Character类型转换为java.lang.Byte类型:%s".formatted(e.getMessage()));
            }
            ...
            try {
                ...
                throw new RuntimeException("无法将java.sql.Clob类型转换为java.lang.Byte类型:%s".formatted(e.getMessage()));
            }
    ...
    public static Short castToShort(final Object in) {
        if (in instanceof Number number) {
            ...
            return (short) java.sql.Timestamp.valueOf(time.toLocalDateTime()).getTime();
            ...
            try {
                ...
                throw new RuntimeException("无法将java.lang.String类型转换为java.lang.Short类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof java.sql.Clob clob) {
            try {
                ...
                throw new RuntimeException("无法将java.sql.Clob类型转换为java.lang.Short类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof Boolean boolean1) {
    ...
    public static Integer castToInteger(final Object in) {
        if (in instanceof Number number) {
            ...
            return (int) java.sql.Timestamp.valueOf(time.toLocalDateTime()).getTime();
        } else if (in instanceof String || in instanceof Character) {
            try {
                String s = in.toString().trim();
                if (s.equalsIgnoreCase("true")) {
                ...
                throw new RuntimeException("无法将java.lang.String类型转换为java.lang.Integer类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof java.sql.Clob clob) {
            try {
                String s = clob2Str(clob);
                ...
                throw new RuntimeException("无法将java.sql.Clob类型转换为java.lang.Integer类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof Boolean boolean1) {
    ...
    public static Long castToLong(final Object in) {
        if (in instanceof Number number) {
            ...
            return java.sql.Timestamp.valueOf(time.toLocalDateTime()).getTime();
        } else if (in instanceof String || in instanceof Character) {
            try {
                String s = in.toString().trim();
                if (s.equalsIgnoreCase("true")) {
                ...
                throw new RuntimeException("无法将java.lang.String类型转换为java.lang.Long类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof java.sql.Clob clob) {
            try {
                String s = clob2Str(clob);
                ...
                throw new RuntimeException("无法将java.sql.Clob类型转换为java.lang.Long类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof Boolean boolean1) {
    ...
    public static Number castToNumeric(final Object in) {
        if (in instanceof Number number) {
            ...
            try {
                ...
                throw new RuntimeException("无法将java.lang.String类型转换为java.lang.Number类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof java.sql.Clob clob) {
            try {
                String s = clob2Str(clob);
                ...
                throw new RuntimeException("无法将java.sql.Clob类型转换为java.lang.Number类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof Boolean boolean1) {
            return boolean1 ? (long) 1 : (long) 0;
        }
    ...
    public static Float castToFloat(final Object in) {
        if (in instanceof Number number) {
            ...
            return (float) java.sql.Timestamp.valueOf(time.toLocalDateTime()).getTime();
        } else if (in instanceof String || in instanceof Character) {
            try {
                String s = in.toString().trim();
                if (s.equalsIgnoreCase("true")) {
                ...
                throw new RuntimeException("无法将java.lang.String类型转换为java.lang.Float类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof java.sql.Clob clob) {
            try {
                String s = clob2Str(clob);
                ...
                throw new RuntimeException("无法将java.sql.Clob类型转换为java.lang.Float类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof Boolean boolean1) {
    ...
    public static Double castToDouble(final Object in) {
        if (in instanceof Number number) {
            ...
            return (double) java.sql.Timestamp.valueOf(time.toLocalDateTime()).getTime();
        } else if (in instanceof String || in instanceof Character) {
            try {
                String s = in.toString().trim();
                if (s.equalsIgnoreCase("true")) {
                ...
                throw new RuntimeException("无法将将java.lang.String类型转换为java.lang.Double类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof java.sql.Clob clob) {
            try {
                String s = clob2Str(clob);
                ...
                throw new RuntimeException("无法将java.sql.Clob类型转换为java.lang.Double类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof Boolean boolean1) {
    ...
    public static LocalDate castToLocalDate(final Object in) {
        if (in instanceof java.sql.Time date) {
            ...
            try {
                ...
                LocalDate localDate = Instant.ofEpochMilli(dt.toSqlDate().getTime()).atZone(ZoneId.systemDefault())
                        .toLocalDate();
                return localDate;
            ...
            try {
                ...
                throw new RuntimeException("无法将java.sql.Clob类型转换为java.time.LocalDate类型:%s".formatted(e.getMessage()));
            }
    ...
    public static LocalTime castToLocalTime(final Object in) {
        if (in instanceof java.sql.Time date) {
            ...
            try {
                ...
                throw new RuntimeException("无法将java.lang.String类型转换为java.sql.Time类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof java.sql.Clob clob) {
            try {
                String v = clob2Str(clob);
                ...
                throw new RuntimeException("无法将java.sql.Clob类型转换为java.sql.Time类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof Number number) {
            java.sql.Timestamp t = new java.sql.Timestamp(number.longValue());
            LocalDateTime localDateTime = LocalDateTime.ofInstant(t.toInstant(), ZoneId.systemDefault());
    ...
    public static LocalDateTime castToLocalDateTime(final Object in) {
        if (in instanceof java.sql.Timestamp t) {
            ...
            try {
                DateTime dt = DateUtil.parse(in.toString());
                LocalDateTime localDateTime = LocalDateTime.ofInstant(dt.toTimestamp().toInstant(),
                        ZoneId.systemDefault());
                return localDateTime;
            } catch (IllegalArgumentException e) {
                throw new RuntimeException("无法将java.lang.String类型转换为java.sql.TimeStamp类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof java.sql.Clob clob) {
            try {
                String v = clob2Str(clob);
                ...
                throw new RuntimeException("无法将java.sql.Clob类型转换为java.sql.TimeStamp类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof Number number) {
            java.sql.Timestamp t = new java.sql.Timestamp(number.longValue());
            LocalDateTime localDateTime = LocalDateTime.ofInstant(t.toInstant(), ZoneId.systemDefault());
    ...
    public static Boolean castToBoolean(final Object in) {
        if (in instanceof Boolean boolean1) {
            ...
            try {
                ...
                throw new RuntimeException("无法将java.lang.String类型转换为java.lang.Boolean类型:%s".formatted(e.getMessage()));
            }
        } else if (in instanceof java.sql.Clob clob) {
            try {
                String v = clob2Str(clob);
                ...
                throw new RuntimeException("无法将java.sql.Clob类型转换为java.lang.Boolean类型:%s".formatted(e.getMessage()));
            }
        }
    ...
    public static String objectToString(final Object in) {
        ...
        if (a.length() == v.length() && StringUtils.equals(a, v)) {
            throw new UnsupportedOperationException(
                    "Unsupported convert " + in.getClass().getName() + " to java.lang.String");
        }
    ...
    public static Object castByDetermine(final Object in) {
        ...
        if (in instanceof BigInteger integer) {
            ...
            return clob2Str(clob);
        } else if (in instanceof java.sql.Array || in instanceof java.sql.SQLXML) {
            try {
