...
public class HandlerMap {
    ...
    static {
        ...
        MIDDLEMEN.put("removeSpace", (originalResult, index) -> originalResult[index] = EmptyUtils.removeSpace((String)originalResult[index]));
        // varchar时间类型转成timestamp
        MIDDLEMEN.put("varchar_to_timestamp", (var1, var2) -> var1[var2] = MultiFormatDateParser.parseToDate((String) var1[var2]));
        // 处理1898年数据
        MIDDLEMEN.put("years_from_1898", (var1, var2) -> {
            ...
            if (StringUtils.isBlank(wjwfsj)) {
                ...
                List<String> probYear = Arrays.stream(yearIndex)
                    .map(index -> {
       ...
       //float_to_varchar
        MIDDLEMEN.put("float_to_varchar", (var1, var2) -> var1[var2] = MultiFormatDateParser.floatToVarchar((Double) var1[var2]));
    }
