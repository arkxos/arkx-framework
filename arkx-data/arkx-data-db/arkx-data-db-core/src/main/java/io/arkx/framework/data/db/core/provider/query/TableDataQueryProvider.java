...
public interface TableDataQueryProvider {
  ...
  default ResultSetWrapper queryTableData(String schemaName, String tableName, String shardDbCode,List<String> fields) {
    return queryTableData(schemaName, tableName, shardDbCode, fields, IncrementPoint.EMPTY, Collections.emptyList());
  }
