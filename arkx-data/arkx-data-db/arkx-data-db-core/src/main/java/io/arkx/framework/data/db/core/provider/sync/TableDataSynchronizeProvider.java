...
public interface TableDataSynchronizeProvider {
   ...
   * @param pks        主键字段列表
   * @param dbSyncMode 库同步模式
   * @param slaveDbCode 分库编码
   */
  void prepare(String schemaName, String tableName, List<String> fieldNames, List<String> pks,String dbSyncMode, String slaveDbCode);
