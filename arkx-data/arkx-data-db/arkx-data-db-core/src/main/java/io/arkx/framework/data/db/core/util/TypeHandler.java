    ...
    public static void typeMapping(List<ColumnDescription> sourceColumnDescriptions,
        ...
        public static Object convert(Object value, String sourceType, String targetType) {
            ...
            try {
                ...
                } else if (targetUpper.contains("number") ||
                    targetUpper.contains("numeric") ||
                ...
                System.err.printf("类型转换失败：从 [%s] 到 [%s]，原始值: [%s]，错误: %s%n",
                    sourceType, targetType, value, e.getMessage());
                return null;
            }
        }
         ...
         * 批量类型转换方法
         *
         * @param values           需要转换的值数组
         * @param sourceTypes      源数据类型列表
         * @param targetTypes      目标数据类型列表
         * @return 转换后的对象数组
         */
         ...
         *
         * @param row              数据行
         * @param sourceColumns    源列定义
         * @param targetColumns    目标列定义
         * @return 转换后的数据行
         */
        public static Object[] convertRow(Object[] row,
                                          List<ColumnDescription> sourceColumns,
            ...
            for (int i = 0; i < row.length; i++) {
                result[i] = convert(row[i],
                    sourceColumns.get(i).getFieldTypeName(),
