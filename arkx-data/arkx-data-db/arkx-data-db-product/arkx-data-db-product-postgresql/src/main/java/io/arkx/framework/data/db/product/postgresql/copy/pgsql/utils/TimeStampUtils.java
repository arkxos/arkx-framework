package io.arkx.framework.data.db.product.postgresql.copy.pgsql.utils;
...
public class TimeStampUtils {
    ...
    public static long convertToPostgresTimeStamp(LocalDateTime localDateTime) {
        ...
        if (localDateTime.isBefore(PostgresEpoch)) {
            long dateInMicroseconds = (localDateTime.toLocalDate().toEpochDay() - DaysBetweenJavaAndPostgresEpochs)
                    * 86400000000L;

            return dateInMicroseconds + timeInMicroseconds;
        } else {
            long dateInMicroseconds = (DaysBetweenJavaAndPostgresEpochs - localDateTime.toLocalDate().toEpochDay())
                    * 86400000000L;
    ...
    /**
     * Converts the given java seconds to postgresql seconds. The conversion is
     * valid for any year 100 BC onwards.
     * <p>
