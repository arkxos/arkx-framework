package io.arkx.framework.data.db.product.postgresql.copy.exceptions;
...
public class ValueHandlerNotRegisteredException extends RuntimeException {
	...
	public ValueHandlerNotRegisteredException(String message, Throwable cause, boolean enableSuppression,
