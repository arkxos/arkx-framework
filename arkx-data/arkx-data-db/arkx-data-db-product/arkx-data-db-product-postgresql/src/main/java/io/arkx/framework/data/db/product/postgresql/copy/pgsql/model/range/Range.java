package io.arkx.framework.data.db.product.postgresql.copy.pgsql.model.range;
...
public class Range<TElementType> {
    ...
    private static int evaluateBoundaryFlags(boolean lowerBoundIsInclusive, boolean upperBoundIsInclusive,
            boolean lowerBoundInfinite, boolean upperBoundInfinite) {
