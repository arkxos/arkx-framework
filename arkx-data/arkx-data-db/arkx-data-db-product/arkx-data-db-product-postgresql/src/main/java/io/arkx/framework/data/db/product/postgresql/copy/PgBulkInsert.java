...
import io.arkx.framework.data.db.product.postgresql.copy.configuration.Configuration;
import io.arkx.framework.data.db.product.postgresql.copy.configuration.IConfiguration;
import io.arkx.framework.data.db.product.postgresql.copy.exceptions.SaveEntityFailedException;
import io.arkx.framework.data.db.product.postgresql.copy.mapping.AbstractMapping;
