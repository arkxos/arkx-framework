...
//	public static boolean backup(List<? extends Schema> schemaList, String backupOperator, String backupMemo) {
...
//		String backupSQL = schemaList.get(0).getInsertAllSQL().substring(0, schemaList.get(0).getInsertAllSQL().length() - 1) + ",?,?,?,?)";
//		backupSQL = StringUtil.replaceEx(backupSQL, schemaList.get(0).getTableCode(), "B" + schemaList.get(0).getTableCode());
...
//			SchemaColumn sc2 = new SchemaColumn("BackupOperator", 1, i + 1, 200, 0, true, false);
//			SchemaColumn sc3 = new SchemaColumn("BackupTime", 12, i + 2, 0, 0, true, false);
//			SchemaColumn sc4 = new SchemaColumn("BackupMemo", 1, i + 3, 50, 0, false, false);
...
//						LogUtil.warn(schema.getTableCode() + "'s mandatory column " + sc.getColumnName() + " can't be null");
//						return false;
//					}
...
//			}
//			String message = "Error:Set backup from " + schemaList.get(0).getTableCode() + " failed:" + e.getMessage();
...
//	}
//	public static boolean deleteAndBackup(List s, String backupOperator, String backupMemo) {
//		if (ObjectUtil.empty(backupMemo))
//			backupMemo = "Delete";
//		try {
//			backupOperator = ObjectUtil.empty(backupOperator) ? User.getUserName() : backupOperator;
