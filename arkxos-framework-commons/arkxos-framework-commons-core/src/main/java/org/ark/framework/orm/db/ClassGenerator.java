...
//			
//			File file = new File(outputdir, upperFirestChar(table.getTableName()) + ".java");
//			
...
//			classInfo.append("\r\n\t*/\r\n\r\n");
//			
//			classInfo.append("\tpublic class ").append(upperFirestChar(table.getTableName())).append("{\r\n");
...
//		sb.append("\t").append("private ").append(column.getType()).append(" ").append(column.getColumnName()).append(";");
...
//			return "int";
//		} else if (type.contains("varchar") || type.contains("date") || type.contains("time") || type.contains("datetime") || type.contains("timestamp") || type.contains("text")
