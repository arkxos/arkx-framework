package com.arkxos.framework.commons.crawl;
	...
	public void login(String loginUrl, String usernameField, String username, String passwordField, String password) {
		...
		try {
			res = Jsoup.connect(loginUrl)
				    .data(usernameField, username, passwordField, password)
				    .method(Method.POST)
				    .execute();
