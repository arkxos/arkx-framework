...
import com.rapidark.framework.data.fasttable.FastColumnIndexType;
...
public class FastDataTableConvertor implements IFastTableConvertor<FastDataTable> {
	...
	public FastDataTable createTable(Class<FastDataTable> type, String tableName, FastColumn[] columns) {
		...
		for (FastColumn lightningColumn : columns) {
			...
			DataColumn dataColumn = new DataColumn(lightningColumn.getName(), dataColumnType, lightningColumn.getLength());
	 ...
	 * @since infinity 1.0
	 */
	private Multimap<Object, Integer> getIndex(String columnName, Map<String, Multimap<Object, Integer>> columnIndexes) {
	...
	@Override
	public ThreeTuple<PkList, List<ByteBuffer>, Map<String, Multimap<Object, Integer>>> buildRowByteBuffers(int existRowCount, List<FastColumn> columns, DataRow[] rows, int typeLength) {
