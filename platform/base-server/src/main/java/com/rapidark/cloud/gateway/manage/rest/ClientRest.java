...
//import com.rapidark.cloud.gateway.formwork.util.ResultBody;
...
////    public ResultBody add(@RequestBody OpenClient client) {
////        Assert.notNull(client, "未获取到对象");
////        client.setAppId(UUIDUtils.getUUIDString());
//////        client.setCreateTime(new Date());
////        this.validate(client);
////        //验证名称是否重复
////        OpenClient qClinet = new OpenClient();
...
////        OpenClient dbClient = clientService.findById(id);
...
////    public ResultBody update(@RequestBody OpenClient client) {
////        Assert.notNull(client, "未获取到对象");
...
////            }
//////            if (StringUtils.isNull(client.getStatus())) {
