package com.xdreamaker.framework.ddd.es.continuance.producer.config;
...
import com.xdreamaker.framework.ddd.es.continuance.producer.jpa.CustomEmbeddedEventStore;
import com.xdreamaker.framework.ddd.es.continuance.producer.jpa.CustomEventSourcingRepository;
import com.xdreamaker.framework.ddd.es.continuance.producer.jpa.CustomJpaEventStorageEngine;
import com.xdreamaker.demo.axon.domain.upcaster.ContractEventUpCaster;
...
/**
 * 自定义的一些配置，由于 EventStorageEngine 的 Auto Config 在自定义了 eventStore 之后就不起作用了，
 * 所以这里把 JpaEventStoreAutoConfiguration 中的内容搬过来了
 *
 * @author darkness
