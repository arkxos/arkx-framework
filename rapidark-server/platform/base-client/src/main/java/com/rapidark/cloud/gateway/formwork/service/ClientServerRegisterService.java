...
public class ClientServerRegisterService extends BaseService<ClientServerRegister, String, ClientServerRegisterRepository> {
     ...
     */
    @Transactional(readOnly = true)
    public Page<Map<String, Object>> clientPageList(String routeId, Pageable pageable){
     ...
     */
    @Transactional(readOnly = true)
    public Page<OpenApp> notRegClientPageList(String routeId, Pageable pageable){
     ...
     */
    @Transactional(readOnly = true)
    public Page<GatewayAppRouteRegServer> serverPageList(String clientId, Pageable pageable){
        return clientServerRegisterRepository.queryRegServers(clientId, pageable);
    }
